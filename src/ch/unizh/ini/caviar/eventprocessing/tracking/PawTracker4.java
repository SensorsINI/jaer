...
import ch.unizh.ini.caviar.eventprocessing.tracking.PawTracker3DStatic;
 ...
 * @author rogister
 */
public class PawTracker4 extends EventFilter2D implements FrameAnnotater, Observer /*, PreferenceChangeListener*/ {
    
    
   //private static Preferences getPrefs()=Preferences.userNodeForPackage(PawTracker4.class);
    ...
    // Parameters appearing in the GUI
     ...
     private float planeAngle=getPrefs().getFloat("PawTracker4.planeAngle",30.0f);
     private float alpha=getPrefs().getFloat("PawTracker4.alpha",0.1f);
     private float intensity=getPrefs().getFloat("PawTracker4.intensity",1);
  
     private int ray_length=getPrefs().getInt("PawTracker4.ray_length",50);
     private int adjustTime=getPrefs().getInt("PawTracker4.adjustTime",0);
    
     private int yLeftCorrection=getPrefs().getInt("PawTracker4.yLeftCorrection",0);
     private int yRightCorrection=getPrefs().getInt("PawTracker4.yRightCorrection",0);
   
     
     private float valueThreshold=getPrefs().getFloat("PawTracker4.valueThreshold",0);
     private float stereoThreshold=getPrefs().getFloat("PawTracker4.stereoThreshold",0.5f);
     
     
     private float shadowFactor=getPrefs().getFloat("PawTracker4.shadowFactor",0.3f);
     private float colorizeFactor=getPrefs().getFloat("PawTracker4.colorizeFactor",0.1f);
     private int colorizePeriod=getPrefs().getInt("PawTracker4.colorizePeriod",183);
   
    
    
      private int obj_xa=getPrefs().getInt("PawTracker4.obj_xa",15);
      private int obj_ya=getPrefs().getInt("PawTracker4.obj_ya",15);
      private int obj_sizea=getPrefs().getInt("PawTracker4.obj_sizea",10);
      private int obj_xb=getPrefs().getInt("PawTracker4.obj_xb",15);
      private int obj_yb=getPrefs().getInt("PawTracker4.obj_yb",15);
      private int obj_sizeb=getPrefs().getInt("PawTracker4.obj_sizeb",10);
      
      private int cube_size=getPrefs().getInt("PawTracker4.cube_size",1);
        
        
    private int door_xa=getPrefs().getInt("PawTracker4.door_xa",52);
    {setPropertyTooltip("door_xa","lower x bound of the cage door");}
    private int door_xb=getPrefs().getInt("PawTracker4.door_xb",88);
    {setPropertyTooltip("door_xb","higher x bound of the cage door");}
    private int door_ya=getPrefs().getInt("PawTracker4.door_ya",50);
    {setPropertyTooltip("door_ya","lower y bound of the cage door");}
    private int door_yb=getPrefs().getInt("PawTracker4.door_yb",127);
    {setPropertyTooltip("door_yb","higher y bound of the cage door");}
    
    private int retinaSize=getPrefs().getInt("PawTracker4.retinaSize",128);
    {setPropertyTooltip("retinaSize","[nb pixels of side] resolution of the retina");}
  
   
    private int minZeroes=getPrefs().getInt("PawTracker4.minZeroes",2);
    {setPropertyTooltip("minZeroes","Minimum number of low value around point for border template matching");}
    private int maxZeroes=getPrefs().getInt("PawTracker4.maxZeroes",6);
    {setPropertyTooltip("maxZeroes","Maximum number of low value around point for border template matching");}
   // private int doorMinZeroes=getPrefs().getInt("PawTracker4.doorMinZeroes",2);
   // private int doorMaxZeroes=getPrefs().getInt("PawTracker4.doorMaxZeroes",6);
    
    
    private float line_threshold=getPrefs().getFloat("PawTracker4.line_threshold",0f);
    {setPropertyTooltip("line_threshold","unused, planned for finding parallel lines");}
    private int score_threshold=getPrefs().getInt("PawTracker4.score_threshold",37);
    {setPropertyTooltip("score_threshold","[intensity 0-100] threshold on intensity score for fingertips detection");}
    private float score_in_threshold=getPrefs().getFloat("PawTracker4.score_in_threshold",0.2f);
    ...
    private float score_sup_threshold=getPrefs().getFloat("PawTracker4.score_sup_threshold",0.1f);
    {setPropertyTooltip("score_sup_threshold","[acc value] threshold on contrast value for fingertips");}  
    private float line2shape_thresh=getPrefs().getFloat("PawTracker4.line2shape_thresh",0.3f);
    {setPropertyTooltip("line2shape_thresh","[acc value] finger without fingertip stops at shape or below this value");} 
    
       
    private int score_range=getPrefs().getInt("PawTracker4.score_range",3);
    {setPropertyTooltip("score_range","[nb pixels] min distance between two detected fingertip");} 
    
    private int line_range=getPrefs().getInt("PawTracker4.line_range",8);
    {setPropertyTooltip("line_range","(unused) min distance between two finger lines");}
    private int lines_n_avg=getPrefs().getInt("PawTracker4.lines_n_avg",8);
    ...
    private float palmback_value = getPrefs().getFloat("PawTracker4.palmback_value",0.6f);
    ...
    private int palmback_distance = getPrefs().getInt("PawTracker4.palmback_distance",30);
    {setPropertyTooltip("palmback_distance","[nb pixels] max length between finger base point and palm back");} 
  
    private int finger_start_threshold=getPrefs().getInt("PawTracker4.finger_start_threshold",45);
    {setPropertyTooltip("finger_start_threshold","[intensity 0-100] threshold for first time fingertip detection");} 
  
    
    private int finger_length=getPrefs().getInt("PawTracker4.finger_length",10);
    {setPropertyTooltip("finger_length","[nb pixels] max length of finger segment");} 
  
    private float finger_mv_smooth=getPrefs().getFloat("PawTracker4.finger_mv_smooth",0.1f);
  
    private float finger_sensitivity=getPrefs().getFloat("PawTracker4.finger_sensitivity",2.0f);
         
   
 
         
    private boolean track = getPrefs().getBoolean("PawTracker4.track",true);
    private boolean showYColor = getPrefs().getBoolean("PawTracker4.showYColor",false);
    private boolean showXColor = getPrefs().getBoolean("PawTracker4.showXColor",false);
    private boolean showZColor = getPrefs().getBoolean("PawTracker4.showZColor",false);
    private boolean showShadows = getPrefs().getBoolean("PawTracker4.showShadows",false);
    private boolean showCorner = getPrefs().getBoolean("PawTracker4.showCorner",false);
 
     
       
    private boolean showFingers = getPrefs().getBoolean("PawTracker4.showFingers",true);
    private boolean showFingerTips = getPrefs().getBoolean("PawTracker4.showFingerTips",true);
 
    private boolean showZones = getPrefs().getBoolean("PawTracker4.showZones",true);
    private boolean showAll = getPrefs().getBoolean("PawTracker4.showAll",true);
   // show intensity inside shape
  
    private boolean showAcc = getPrefs().getBoolean("PawTracker4.showAcc",false);
    private boolean showOnlyAcc = getPrefs().getBoolean("PawTracker4.showOnlyAcc",false);
    private boolean showDecay = getPrefs().getBoolean("PawTracker4.showDecay",false);
    
    
   private boolean scaleAcc = getPrefs().getBoolean("PawTracker4.scaleAcc",true);
    
    
    private boolean showFrame = getPrefs().getBoolean("PawTracker4.showFrame",true);  
    private boolean showWindow = getPrefs().getBoolean("PawTracker4.showWindow",true);
    private boolean showScore = getPrefs().getBoolean("PawTracker4.showScore",false);
   
              
              
    private boolean showShapePoints = getPrefs().getBoolean("PawTracker4.showShapePoints",true);
    private boolean showFingerPoints = getPrefs().getBoolean("PawTracker4.showFingerPoints",true);
  
    
    
    private boolean showShape = getPrefs().getBoolean("PawTracker4.showShape",true);
    private boolean showRays = getPrefs().getBoolean("PawTracker4.showRays",false);
    private boolean showAxes = getPrefs().getBoolean("PawTracker4.showAxes",true);
  
    
    
     
    private int lowFilter_radius=getPrefs().getInt("PawTracker4.lowFilter_radius",3);
    private int lowFilter_density=getPrefs().getInt("PawTracker4.lowFilter_density",17);
    private float lowFilter_threshold=getPrefs().getFloat("PawTracker4.lowFilter_threshold",0);   
    
    private int lowFilter_radius2=getPrefs().getInt("PawTracker4.lowFilter_radius2",10);
    private int lowFilter_density2=getPrefs().getInt("PawTracker4.lowFilter_density2",5);
   
 
    
   
    private boolean showPalm = getPrefs().getBoolean("PawTracker4.showPalm",false);   
    
    private boolean showSkeletton = getPrefs().getBoolean("PawTracker4.showSkeletton",false);
    private boolean showSecondFilter = getPrefs().getBoolean("PawTracker4.showSecondFilter",false);
    private boolean showTopography = getPrefs().getBoolean("PawTracker4.showTopography",false);
  
    
    private boolean resetPawTracking=getPrefs().getBoolean("PawTracker4.resetPawTracking",false);
    private boolean validateParameters=getPrefs().getBoolean("PawTracker4.validateParameters",false);
  
    private float event_strength=getPrefs().getFloat("PawTracker4.event_strength",2f);
    private float intensity_strength=getPrefs().getFloat("PawTracker4.intensity_strength",0.5f);
    private float intensity_threshold=getPrefs().getFloat("PawTracker4.intensity_threshold",0.5f);
    private float in_value_threshold=getPrefs().getFloat("PawTracker4.in_value_threshold",0.2f);
    private float sk_threshold=getPrefs().getFloat("PawTracker4.sk_threshold",0.2f);
 
    
    private float finger_border_mix=getPrefs().getFloat("PawTracker4.finger_border_mix",0.1f);
    private float finger_tip_mix=getPrefs().getFloat("PawTracker4.finger_tip_mix",0.5f);
    private int finger_surround=getPrefs().getInt("PawTracker4.finger_surround",10);
    private int finger_creation_surround=getPrefs().getInt("PawTracker4.finger_creation_surround",30);
             
    private int intensity_range=getPrefs().getInt("PawTracker4.intensity_range",2);
       
    private int decayTimeLimit=getPrefs().getInt("PawTracker4.decayTimeLimit",10000);
    {setPropertyTooltip("decayTimeLimit","[microsec (us)] for decaying accumulated events");}
    private boolean decayOn = getPrefs().getBoolean("PawTracker4.decayOn",false); 
    ...
    PawTracker3DStatic paw3DTracker; 
    int trackerID;
   ...
   // protected float stopPoint = 0f;
    ...
    public PawTracker4(AEChip chip) {
        ...
        System.out.println("End build resetPawTracker4");
    ...
    private void resetPawTracker(){
        ...
        System.out.println("resetPawTracker4");
       ...
       System.out.println("End of resetPawTracker4");
    }
    ...
    synchronized private void track(EventPacket<TypedEvent> ae){
        ...
        paw3DTracker.track(eventPoints,currentTime,trackerID);
...
//        getPrefs().putFloat("PawTracker4.mixingFactor",mixingFactor);
//    }
...
//        getPrefs().putFloat("PawTracker4.surround",surround);
//    }
...
//    }
    ...
    synchronized public void annotate(GLAutoDrawable drawable) {
        ...
        if(gl==null){
            log.warning("null GL in PawTracker4.annotate");
            return;
        }
...
//        getPrefs().putFloat("PawTracker4.in_threshold",in_threshold);
//    }
...
//    }
    ...
    public void setLine_threshold(float line_threshold) {
        ...
        getPrefs().putFloat("PawTracker4.line_threshold",line_threshold);
    }
    ...
    public void setLine_range(int line_range) {
        ...
        getPrefs().putInt("PawTracker4.line_range",line_range);
    }
    ...
    public void setLines_n_avg(int lines_n_avg) {
        ...
        getPrefs().putInt("PawTracker4.lines_n_avg",lines_n_avg);
    }
    ...
    public void setScore_range(int score_range) {
        ...
        getPrefs().putInt("PawTracker4.score_range",score_range);
    }
    ...
    public void setScore_threshold(int score_threshold) {
        ...
        getPrefs().putInt("PawTracker4.score_threshold",score_threshold);
    }
    ...
    public void setScore_in_threshold(float score_in_threshold) {
        ...
        getPrefs().putFloat("PawTracker4.score_in_threshold",score_in_threshold);
    }
    ...
    public void setScore_sup_threshold(float score_sup_threshold) {
        ...
        getPrefs().putFloat("PawTracker4.score_sup_threshold",score_sup_threshold);
    }
   ...
   public void setLine2shape_thresh(float line2shape_thresh) {
        ...
        getPrefs().putFloat("PawTracker4.line2shape_thresh",line2shape_thresh);
    }
    ...
    public void setShapeLimit(float shapeLimit) {
        ...
        getPrefs().putFloat("PawTracker4.shapeLimit",shapeLimit);
    }
    ...
    public void setShapeDLimit(float shapeDLimit) {
        ...
        getPrefs().putFloat("PawTracker4.shapeDLimit",shapeDLimit);
    }
    ...
    public void setDecayTimeLimit(int decayTimeLimit) {
        ...
        getPrefs().putInt("PawTracker4.decayTimeLimit",decayTimeLimit);
    }
    ...
    public void setIntensityZoom(int intensityZoom) {
        ...
        getPrefs().putInt("PawTracker4.intensityZoom",intensityZoom);
    }
    ...
    public void setObj_xa(int obj_xa) {
        ...
        getPrefs().putInt("PawTracker4.obj_xa",obj_xa);
    }
    ...
    public int getObj_xa() {
     ...
     public void setObj_ya(int obj_ya) {
        ...
        getPrefs().putInt("PawTracker4.obj_ya",obj_ya);
    }
    ...
    public int getObj_ya() {
     ...
     public void setObj_xb(int obj_xb) {
        ...
        getPrefs().putInt("PawTracker4.obj_xb",obj_xb);
    }
    ...
    public int getObj_xb() {
     ...
     public void setObj_yb(int obj_yb) {
        ...
        getPrefs().putInt("PawTracker4.obj_yb",obj_yb);
    }
    ...
    public int getObj_yb() {
     ...
     public void setObj_sizea(int obj_sizea) {
        ...
        getPrefs().putInt("PawTracker4.obj_sizea",obj_sizea);
    }
    ...
    public void setObj_sizeb(int obj_sizeb) {
        ...
        getPrefs().putInt("PawTracker4.obj_sizeb",obj_sizeb);
    }
    ...
    public void setDoor_xa(int door_xa) {
        ...
        getPrefs().putInt("PawTracker4.door_xa",door_xa);
    }
    ...
    public void setDoor_xb(int door_xb) {
        ...
        getPrefs().putInt("PawTracker4.door_xb",door_xb);
    }
    ...
    public void setDoor_ya(int door_ya) {
        ...
        getPrefs().putInt("PawTracker4.door_ya",door_ya);
    }
    ...
    public void setDoor_yb(int door_yb) {
        ...
        getPrefs().putInt("PawTracker4.door_yb",door_yb);
    }
    ...
    public void setNode_range(float node_range) {
        ...
        getPrefs().putFloat("PawTracker4.node_range",node_range);
    }
    ...
    public void setFinger_sensitivity(float finger_sensitivity) {
        ...
        getPrefs().putFloat("PawTracker4.finger_sensitivity",finger_sensitivity);
    }
    ...
    public void setFinger_mv_smooth(float finger_mv_smooth) {
        ...
        getPrefs().putFloat("PawTracker4.finger_mv_smooth",finger_mv_smooth);
    }
    ...
    public void setFinger_length(int finger_length) {
        ...
        getPrefs().putInt("PawTracker4.finger_length",finger_length);
    }
    ...
    public void setFinger_start_threshold(int finger_start_threshold) {
        ...
        getPrefs().putInt("PawTracker4.finger_start_threshold",finger_start_threshold);
    }
    ...
    public void setFinger_cluster_range(float finger_cluster_range) {
        ...
        getPrefs().putFloat("PawTracker4.finger_cluster_range",finger_cluster_range);
    }
    ...
    public void setFinger_ori_variance(float finger_ori_variance) {
        ...
        getPrefs().putFloat("PawTracker4.finger_ori_variance",finger_ori_variance);
    }
    ...
    public void setPalmback_below(float palmback_below) {
        ...
        getPrefs().putFloat("PawTracker4.palmback_below",palmback_below);
    }
    ...
    public void setPalmback_value(float palmback_value) {
        ...
        getPrefs().putFloat("PawTracker4.palmback_value",palmback_value);
    }
    ...
    public void setPalmback_distance(int palmback_distance) {
        ...
        getPrefs().putInt("PawTracker4.palmback_distance",palmback_distance);
    }
    ...
    public void setIntensity_range(int intensity_range) {
        ...
        getPrefs().putInt("PawTracker4.intensity_range",intensity_range);
    }
    ...
    public void setIn_value_threshold(float in_value_threshold) {
        ...
        getPrefs().putFloat("PawTracker4.in_value_threshold",in_value_threshold);
    }
    ...
    public void setIntensity_threshold(float intensity_threshold) {
        ...
        getPrefs().putFloat("PawTracker4.intensity_threshold",intensity_threshold);
    }
    ...
    public void setIntensity_strength(float intensity_strength) {
        ...
        getPrefs().putFloat("PawTracker4.intensity_strength",intensity_strength);
    }
    ...
    public void setEvent_strength(float event_strength) {
        ...
        getPrefs().putFloat("PawTracker4.event_strength",event_strength);
    }
    ...
    public void setShapeThreshold(float shapeThreshold) {
        ...
        getPrefs().putFloat("PawTracker4.shapeThreshold",shapeThreshold);
    }
    ...
    public void setShapeDThreshold(float shapeDThreshold) {
        ...
        getPrefs().putFloat("PawTracker4.shapeDThreshold",shapeDThreshold);
    }
    ...
    public void setDoorMinDiff(float doorMinDiff) {
        ...
        getPrefs().putFloat("PawTracker4.doorMinDiff",doorMinDiff);
    }
    ...
    public void setDoorMaxDiff(float doorMaxDiff) {
        ...
        getPrefs().putFloat("PawTracker4.doorMaxDiff",doorMaxDiff);
    }
    ...
    public void setMinZeroes(int minZeroes) {
        ...
        getPrefs().putInt("PawTracker4.minZeroes",minZeroes);
    }
    ...
    public void setMaxZeroes(int maxZeroes) {
        ...
        getPrefs().putInt("PawTracker4.maxZeroes",maxZeroes);
    }
...
//        paw3DTracker.;getPrefs().putInt("PawTracker4.doorMinZeroes",doorMinZeroes);
//    }
...
//        paw3DTracker.;getPrefs().putInt("PawTracker4.doorMaxZeroes",doorMaxZeroes);
//    }
...
//        getPrefs().putInt("PawTracker4.retinaSize",retinaSize);
//        
//    }
    ...
    public void setResetPawTracking(boolean resetPawTracking) {
        ...
        getPrefs().putBoolean("PawTracker4.resetPawTracking",resetPawTracking);
    ...
    public void setValidateParameters(boolean validateParameters) {
        ...
        getPrefs().putBoolean("PawTracker4.validateParameters",validateParameters);
    ...
    public void setShowSkeletton(boolean showSkeletton){
        ...
        getPrefs().putBoolean("PawTracker4.showSkeletton",showSkeletton);
    }
    ...
    public void setShowSecondFilter(boolean showSecondFilter){
        ...
        getPrefs().putBoolean("PawTracker4.showSecondFilter",showSecondFilter);
    }
    ...
    public void setShowTopography(boolean showTopography){
        ...
        getPrefs().putBoolean("PawTracker4.showTopography",showTopography);
    }
    ...
    public void setShowPalm(boolean showPalm){
        ...
        getPrefs().putBoolean("PawTracker4.showPalm",showPalm);
    }
    public boolean isShowPalm(){
     ...
     public void setScaleAcc(boolean scaleAcc){
        ...
        getPrefs().putBoolean("PawTracker4.scaleAcc",scaleAcc);
    }
    ...
    public void setShowAcc(boolean showAcc){
        ...
        getPrefs().putBoolean("PawTracker4.showAcc",showAcc);
    }
    ...
    public void setShowOnlyAcc(boolean showOnlyAcc){
        ...
        getPrefs().putBoolean("PawTracker4.showOnlyAcc",showOnlyAcc);
    }
    ...
    public void setShowDecay(boolean showDecay){
        ...
        getPrefs().putBoolean("PawTracker4.showDecay",showDecay);
    }
    ...
    public void setDecayOn(boolean decayOn){
        ...
        getPrefs().putBoolean("PawTracker4.decayOn",decayOn);
    }
    ...
    public void setShowFrame(boolean showFrame){
        ...
        getPrefs().putBoolean("PawTracker4.showFrame",showFrame);
    }
    ...
    public void setShowWindow(boolean showWindow){
        ...
        getPrefs().putBoolean("PawTracker4.showWindow",showWindow);
    }
    ...
    public void setShowScore(boolean showScore){
        ...
        getPrefs().putBoolean("PawTracker4.showScore",showScore);
    }
    ...
    public void setShowFingers(boolean showFingers){
        ...
        getPrefs().putBoolean("PawTracker4.showFingers",showFingers);
    }
    ...
    public void setShowFingerTips(boolean showFingerTips){
        ...
        getPrefs().putBoolean("PawTracker4.showFingerTips",showFingerTips);
    }
    ...
    public void setShowZones(boolean showZones){
        ...
        getPrefs().putBoolean("PawTracker4.showZones",showZones);
    }
    ...
    public void setShowAll(boolean showAll){
        ...
        getPrefs().putBoolean("PawTracker4.showAll",showAll);
    }
    public boolean isShowAll(){
     ...
     public void setTrack(boolean track){
        ...
        getPrefs().putBoolean("PawTracker4.track",track);
    }
...
//        paw3DTracker.;getPrefs().putBoolean("PawTracker4.showSequences",showSequences);
//    }
...
//    }
      ...
      public void setShowRays(boolean showRays){
        ...
        paw3DTracker.setShowRays( showRays);
        getPrefs().putBoolean("PawTracker4.showRays",showRays);
    }
    public boolean isShowRays(){
      ...
      public void setShowAxes(boolean showAxes){
        ...
        getPrefs().putBoolean("PawTracker4.showAxes",showAxes);
    }
    ...
    public void setShowShape(boolean showShape){
        ...
        getPrefs().putBoolean("PawTracker4.showShape",showShape);
    }
    ...
    public void setShowShapePoints(boolean showShapePoints){
        ...
        getPrefs().putBoolean("PawTracker4.showShapePoints",showShapePoints);
    }
    public boolean isShowShapePoints(){
     ...
     public void setShowFingerPoints(boolean showFingerPoints){
        ...
        getPrefs().putBoolean("PawTracker4.showFingerPoints",showFingerPoints);
    }
    ...
    public void setLowFilter_radius(int lowFilter_radius) {
        ...
        getPrefs().putInt("PawTracker4.lowFilter_radius",lowFilter_radius);
    }
    ...
    public void setLowFilter_density(int lowFilter_density) {
        ...
        getPrefs().putInt("PawTracker4.lowFilter_density",lowFilter_density);
    }
    ...
    public void setLowFilter_threshold(float lowFilter_threshold) {
        ...
        getPrefs().putFloat("PawTracker4.lowFilter_threshold",lowFilter_threshold);
    }
    ...
    public void setLowFilter_radius2(int lowFilter_radius2) {
        ...
        getPrefs().putInt("PawTracker4.lowFilter_radius2",lowFilter_radius2);
    }
    ...
    public void setLowFilter_density2(int lowFilter_density2) {
        ...
        getPrefs().putInt("PawTracker4.lowFilter_density2",lowFilter_density2);
    }
    ...
    public void setFinger_border_mix(float finger_border_mix) {
        ...
        getPrefs().putFloat("PawTracker4.finger_border_mix",finger_border_mix);
    }
    ...
    public void setFinger_tip_mix(float finger_tip_mix) {
        ...
        getPrefs().putFloat("PawTracker4.finger_tip_mix",finger_tip_mix);
    }
    ...
    public void setFinger_surround(int finger_surround) {
        ...
        getPrefs().putInt("PawTracker4.finger_surround",finger_surround);
    }
    ...
    public void setFinger_creation_surround(int finger_creation_surround) {
        ...
        getPrefs().putInt("PawTracker4.finger_creation_surround",finger_creation_surround);
    }
    ...
    public void setBrightness(float brightness) {
        ...
        getPrefs().putFloat("PawTracker4.brightness",brightness);
    }
    ...
    public void setSk_threshold(float sk_threshold) {
        ...
        getPrefs().putFloat("PawTracker4.sk_threshold",sk_threshold);
    }
    ...
    public void setPlaneAngle(float planeAngle) {
        ...
        getPrefs().putFloat("PawTracker4.planeAngle",planeAngle);
    }
    
    public void setAlpha(float alpha) {
        this.alpha = alpha;
        paw3DTracker.setAlpha( alpha);
        getPrefs().putFloat("PawTracker4.alpha",alpha);
    }
    ...
    public void setIntensity(float intensity) {
        ...
        getPrefs().putFloat("PawTracker4.intensity",intensity);
    }
    ...
    public void setRay_length(int ray_length) {
        ...
        getPrefs().putInt("PawTracker4.ray_length",ray_length);
    }
    ...
    public void setAdjustTime(int adjustTime) {
        ...
        getPrefs().putInt("PawTracker4.adjustTime",adjustTime);
    }
    ...
    public void setValueThreshold(float valueThreshold) {
        ...
        getPrefs().putFloat("PawTracker4.valueThreshold",valueThreshold);
    }
    ...
    public void setStereoThreshold(float stereoThreshold) {
        ...
        getPrefs().putFloat("PawTracker4.stereoThreshold",stereoThreshold);
    }
    ...
    public void setYLeftCorrection(int yLeftCorrection) {
        ...
        getPrefs().putInt("PawTracker4.yLeftCorrection",yLeftCorrection);
    }
    ...
    public void setYRightCorrection(int yRightCorrection) {
        ...
        getPrefs().putInt("PawTracker4.yRightCorrection",yRightCorrection);
    }
    ...
    public void setColorizeFactor(float colorizeFactor) {
           ...
           getPrefs().putFloat("PawTracker4.colorizeFactor",colorizeFactor);
   }
   public float getColorizeFactor() {
    ...
    public void setShadowFactor(float shadowFactor) {
           ...
           getPrefs().putFloat("PawTracker4.shadowFactor",shadowFactor);
   }
   public float getShadowFactor() {
     ...
     public void setColorizePeriod(int colorizePeriod) {
        ...
        getPrefs().putInt("PawTracker4.colorizePeriod",colorizePeriod);
    }
    ...
    public void setShowZColor(boolean showZColor){
        ...
        getPrefs().putBoolean("PawTracker4.showZColor",showZColor);
    }
    ...
    public void setShowYColor(boolean showYColor){
        ...
        getPrefs().putBoolean("PawTracker4.showYColor",showYColor);
    }
    public boolean isShowYColor(){
     ...
     public void setShowXColor(boolean showXColor){
        ...
        getPrefs().putBoolean("PawTracker4.showXColor",showXColor);
    }
    public boolean isShowXColor(){
      ...
      public void setShowShadows(boolean showShadows){
        ...
        getPrefs().putBoolean("PawTracker4.showShadows",showShadows);
    }
    public boolean isShowShadows(){
        ...
        getPrefs().putBoolean("PawTracker4.showCorner",showCorner);
    }
    public boolean isShowCorner(){
      ...
      public void setCube_size(int cube_size) {
        ...
        getPrefs().putInt("PawTracker4.cube_size",cube_size);
    }
