...
//    JFrame preferencesFrame;
    ...
    private boolean measureVelocity=prefs.getBoolean("ClassTracker.showVelocity",true); // enabling this enables both computation and rendering of cluster velocities
