...
public class CypressFX2 implements UsbIoErrorCodes, PnPNotifyInterface, AEMonitorInterface, ReaderBufferControl {
    ...
    // The new binary file format is .iic (i2c) format which are image files for the EEPROM. IIC files will not
    ...
    public final static String FIRMWARE_FILENAME_COCHLEAAMS_BIX = "/ch/unizh/ini/caviar/hardwareinterface/usb/firmwareFX2_Cochleaams1b.bix";
...
//        log.info("setting event acquisition="+enable);
     ...
     * a third serial number string. Default value is 2.
     */
...
//        System.out.println("CypressFX2RetinaBiasgen.unconfigureDevice()");
    ...
    synchronized void downloadFirmwareBinary() throws HardwareInterfaceException {
        ...
        log.info("device has no string identifier, downloading binary firmware to CypressFX2 RAM (volatile, on-chip) memory");
