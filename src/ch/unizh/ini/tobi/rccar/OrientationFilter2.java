 ...
 * @author tobi/phess
 */
public class OrientationFilter2 extends EventFilter2D implements Observer, FrameAnnotater {
    ...
    private int length=getPrefs().getInt("SimpleOrientationFilter.searchDistance",1);
    private int width=getPrefs().getInt("SimpleOrientationFilter.width",1);
    {
...
//    int[][][][] lastOutputTimesMap;
    ...
    public OrientationFilter2(AEChip chip) {
        super(chip);
