 ...
 *
 * The method int setValue(int configWord, int newValue) is used to update the
 * whole configuration word with the new value of the parameter
 */
public class MultiBitValue {
     ...
     *
     * @param length Bit-length of the parameter.
     * @param position 0-based bit-index of the parameter.
