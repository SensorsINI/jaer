...
/**
 * A GUI control component for controlling an IPot. It provides a slider and
 * text field for entry of the IPot current. It is installed in the
 * GUIPotControl.
 *
 * @author tobi
 */
...
// the IPot is the master; it is an Observable that notifies Observers when its value changes.
    ...
    public SimpleIPotSliderTextControl(final IPot pot) {
        ...
        sliderEnabled = SimpleIPotSliderTextControl.prefs.getBoolean("IPotGUIControl.sliderEnabled", true);
        valueEnabled = SimpleIPotSliderTextControl.prefs.getBoolean("IPotGUIControl.currentEnabled", true);
