...
/**
 * Generic 1024x768 XGA DVS
 *
 * @author tobi
 */
@Description("Generic 1280x720 SD DVS for visualizing data")
@DevelopmentStatus(DevelopmentStatus.Status.Stable)
public class DVS1280x720SD extends AETemporalConstastRetina implements Serializable {
    ...
    public DVS1280x720SD() {
        ...
        dvsRenderer = new DVS1280x720SD.DvsRenderer(this);
     ...
     * biasgen.
     */
    public DVS1280x720SD(HardwareInterface hardwareInterface) {
        this();
