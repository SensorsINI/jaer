...
/**
 * Describes tmpdiff128 retina and its event extractor and bias generator. Two
 * constructors ara available, the vanilla constructor is used for event
...
public class Tmpdiff128 extends AETemporalConstastRetina implements Serializable {
    ...
    /**
     * Creates a new instance of Tmpdiff128. No biasgen is constructed for this
    ...
    /**
     * the event extractor for Tmpdiff128. Tmpdiff128 has two polarities 0 and
     * 1. Here the polarity is flipped by the extractor so that the raw polarity
     * 0 becomes 1 in the extracted event. The ON events have raw polarity 0. 1
     * is an ON event after event extraction, which flips the type. Raw polarity
     * 1 is OFF event, which becomes 0 after extraction.
     */
    ...
    /**
     * Describes IPots on tmpdiff128 retina chip. These are configured by a
     * shift register as shown here:
     * <p>
