 ...
 */
public final class CochleaTow4EarControlPanel extends JTabbedPane implements Observer {

	private static final long serialVersionUID = -7435419921722582550L;

	private final Logger log = Logger.getLogger("CochleaTow4EarControlPanel");

	private final CochleaTow4Ear chip;
	private final CochleaTow4Ear.Biasgen biasgen;
	...
	public class CochleaChannelControlPanel extends JPanel implements StateEditable {
		...
		public CochleaChannelControlPanel(final CochleaChannel chan) {
			...
			tf0.setMinimumSize(new Dimension(CochleaTow4EarControlPanel.TF_MIN_W, CochleaTow4EarControlPanel.TF_HEIGHT));
			tf0.setPreferredSize(new Dimension(CochleaTow4EarControlPanel.TF_PREF_W, CochleaTow4EarControlPanel.TF_HEIGHT));
			tf0.setMaximumSize(new Dimension(CochleaTow4EarControlPanel.TF_MAX_W, CochleaTow4EarControlPanel.TF_MAX_HEIGHT));
			...
			tf1.setMinimumSize(new Dimension(CochleaTow4EarControlPanel.TF_MIN_W, CochleaTow4EarControlPanel.TF_HEIGHT));
			tf1.setPreferredSize(new Dimension(CochleaTow4EarControlPanel.TF_PREF_W, CochleaTow4EarControlPanel.TF_HEIGHT));
			tf1.setMaximumSize(new Dimension(CochleaTow4EarControlPanel.TF_MAX_W, CochleaTow4EarControlPanel.TF_MAX_HEIGHT));
			...
			tf2.setMinimumSize(new Dimension(CochleaTow4EarControlPanel.TF_MIN_W, CochleaTow4EarControlPanel.TF_HEIGHT));
			tf2.setPreferredSize(new Dimension(CochleaTow4EarControlPanel.TF_PREF_W, CochleaTow4EarControlPanel.TF_HEIGHT));
			tf2.setMaximumSize(new Dimension(CochleaTow4EarControlPanel.TF_MAX_W, CochleaTow4EarControlPanel.TF_MAX_HEIGHT));
			...
			tf3.setMinimumSize(new Dimension(CochleaTow4EarControlPanel.TF_MIN_W, CochleaTow4EarControlPanel.TF_HEIGHT));
			tf3.setPreferredSize(new Dimension(CochleaTow4EarControlPanel.TF_PREF_W, CochleaTow4EarControlPanel.TF_HEIGHT));
			tf3.setMaximumSize(new Dimension(CochleaTow4EarControlPanel.TF_MAX_W, CochleaTow4EarControlPanel.TF_MAX_HEIGHT));
			...
			tf4.setMinimumSize(new Dimension(CochleaTow4EarControlPanel.TF_MIN_W, CochleaTow4EarControlPanel.TF_HEIGHT));
			tf4.setPreferredSize(new Dimension(CochleaTow4EarControlPanel.TF_PREF_W, CochleaTow4EarControlPanel.TF_HEIGHT));
			tf4.setMaximumSize(new Dimension(CochleaTow4EarControlPanel.TF_MAX_W, CochleaTow4EarControlPanel.TF_MAX_HEIGHT));
			...
			if (chan != null) {
				...
				chan.addObserver(CochleaTow4EarControlPanel.this);
			}
	...
	protected void tabbedPaneMouseClicked(final MouseEvent evt) {
		chip.getPrefs().putInt("CochleaTow4EarControlPanel.bgTabbedPaneSelectedIndex", getSelectedIndex());
	}
