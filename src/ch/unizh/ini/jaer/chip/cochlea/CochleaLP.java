    ...
    public static class Renderer extends AEChipRenderer {
        ...
        protected void checkTypeColors(final int numCellTypes) {
            ...
            for (int type = 0; type < 4; type++) {
                colors[type].getRGBColorComponents(typeColorRGBComponents[type]); // fill the typeColorRGBComponents array for this type from the color for this type
            }
        }
    }
