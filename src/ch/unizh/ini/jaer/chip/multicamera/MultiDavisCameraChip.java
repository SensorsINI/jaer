...
//            }
//            
////        JAERV.zeroTimestamps(); // ?????? is it usefull????
...
//        }
//        
//        multiCameraMenu = new JMenu("Multicamera Menu");
//        multiCameraMenu.add(new JMenuItem(new MultiDavisCameraChip.createMultipleAEViewer()));
//        mainAEV=getMultiChip().getAeViewer(); 
//        mainAEV.addMenu(multiCameraMenu);
//    }
//  
//    @Override
...
//                JAERV.removeViewer(camerasAEVs[i]);
