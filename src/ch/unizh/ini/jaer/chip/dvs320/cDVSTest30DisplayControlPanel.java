...
/**
 * Controls display of cDVS data on cDVSTest30.
 *
 * @author Tobi
 */
public class cDVSTest30DisplayControlPanel extends javax.swing.JPanel implements PropertyChangeListener{

    private cDVSTest30DisplayMethod displayMethod=null;
    private cDVSTest30Renderer renderer=null;
    private cDVSTest30 chip;

    /** Creates new form cDVSTest30DisplayControlPanel */
    public cDVSTest30DisplayControlPanel(cDVSTest30 chip) {
        this.chip=chip;
     ...
     */
    public void setChip(cDVSTest30 chip) {
        this.chip = chip;
    }
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        if(evt.getPropertyName()==AEChipRenderer.PROPERTY_COLOR_SCALE){
            ...
            gainAGCTF.setText(String.format("%.0f",cDVSTest30.MAX_ADC/(f.y-f.x)));
