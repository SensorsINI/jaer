 ...
 * @author  tobi
 */
public class cDVSTest30OutputControlPanel extends javax.swing.JPanel {
    ...
    class OutputSelectionAction extends AbstractAction implements Observer {
        ...
        cDVSTest30.cDVSTestBiasgen.OutputMux mux;
        int channel;
        JRadioButton button;
    ...
    public cDVSTest30OutputControlPanel(cDVSTest30 chip) {
        this.chip = chip;
        initComponents();
    }
    ...
    void buildPanel() {
        ...
        panelBuilt = true;
        cDVSTest30.cDVSTestBiasgen biasgen = (cDVSTest30.cDVSTestBiasgen) chip.getBiasgen();
        cDVSTest30.cDVSTestBiasgen.AllMuxes muxes = biasgen.allMuxes;
        for (cDVSTest30.cDVSTestBiasgen.OutputMux m : muxes) {
            JPanel p = new JPanel();
            p.setAlignmentY(0);
