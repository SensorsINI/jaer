...
/**
 * Controls display of cDVS data on SeeBetter1011_Temporary.
 *
 * @author Tobi
 */
public class SeeBetter1011_TemporaryDisplayControlPanel extends javax.swing.JPanel implements PropertyChangeListener{

    private cDVSTest30DisplayMethod displayMethod=null;
    private cDVSTest30Renderer renderer=null;
    private SeeBetter1011_Temporary chip;

    /** Creates new form cDVSTest30DisplayControlPanel */
    public SeeBetter1011_TemporaryDisplayControlPanel(SeeBetter1011_Temporary chip) {
        this.chip=chip;
        this.displayMethod=(cDVSTest30DisplayMethod)chip.getCanvas().getDisplayMethod();
        this.renderer=(cDVSTest30Renderer)chip.getRenderer();
        initComponents();
     ...
     */
    public cDVSTest30DisplayMethod getDisplayMethod() {
     ...
     */
    public void setDisplayMethod(cDVSTest30DisplayMethod displayMethod) {
     ...
     * @return the chip
     */
    public SeeBetter1011_Temporary getChip() {
        return chip;
    }
     ...
     */
    public void setChip(SeeBetter1011_Temporary chip) {
        this.chip = chip;
    }
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        if(evt.getPropertyName()==AEChipRenderer.PROPERTY_COLOR_SCALE){
            ...
            gainAGCTF.setText(String.format("%.0f",SeeBetter1011_Temporary.MAX_ADC/(f.y-f.x)));
     ...
     * @return the renderer
     */
    public cDVSTest30Renderer getRenderer() {
        return renderer;
    }
