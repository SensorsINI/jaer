 ...
 * @author oconnorp
 */
public class STDPStack<LayerType extends STDPStack.STDPLayer> extends SpikeStack<LayerType>{
    
    STDPrule stdp=new STDPStack.STDPrule();;
    
    float stdpWin;
    
    public static class STDPrule {

        float plusStrength = 0.1f;
        float minusStrength= -0.1f;
    ...
    {   
        STDPStack.STDPrule stdp=new STDPStack.STDPrule();;
    ...
    public static class STDPLayer <NetType extends STDPStack,LayerType extends STDPStack.STDPLayer, UnitType extends SpikeStack.Layer.Unit> extends SpikeStack.Layer<NetType,LayerType,UnitType>
    {
        ...
        boolean enableSTDP;     // Enable STDP on the slow weights
        ...
        /* Apply STDP learning rule
            ...
            * 
            * The layer keeps a "bookmark" of the current position 
            */
        public void stdpLearn(){
            ...
            */ 
            ...
            {   // Iterate over new output spikes
                ...
                Event evout=Lout.getOutputEvent(outBufferBookmark); // TODO: REMOVE THIS F'ING CAST
...
//                    Event evin=outBuffer.get(tempBookmark);
                    Event evin=getOutputEvent(tempBookmark);
