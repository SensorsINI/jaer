...
//        SpikeStack net=new SpikeStack();
        //
        STSTDPStack<STSTDPStack.Layer> net = new STSTDPStack();
        ...
        {   int number=i<nEvents/2?8:2;
            net.addToQueue(new Event(number,(double)5000*(i/(float)nEvents),3));
        }
    ...
    public static void learningDemo()
    {
        ...
        {   es.reset();
            LinkedList<Event> events=aevents2events(aef.events);
    ...
    public static LinkedList<Event> aevents2events(ArrayList<AERFile.Event> events)
    {   
        LinkedList<Event> evts =new LinkedList<Event>();
        ...
        {   AERFile.Event ev=events.get(i);
            ...
            Event enew=new Event(ev.addr/4, (double)(ev.timestamp-events.get(0).timestamp)/1000., 0);
    ...
    public static void plotEvents(Queue<Event> evts)
    {   
        Iterator<Event> itr=evts.iterator();
