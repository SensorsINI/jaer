...
public class OldITDBinsPanel extends JPanel {
    private Logger log = Logger.getLogger("JAERITDViewer");
    public OldITDBins myBins;
    volatile boolean stopflag = false;
    private long frameDelayMs = 500;
    // activity
    private final int NUM_ACTIVITY_SAMPLES = 20;
    ...
    public void updateBins(OldITDBins newBins) {
        myBins=newBins;
        activitySeries = null;
        activitySeries = new Series(2, myBins.numOfBins+1);
        this.repaint();
    }
