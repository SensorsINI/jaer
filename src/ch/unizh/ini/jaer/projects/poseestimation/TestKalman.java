...
public class TestKalman extends EventFilter2D implements FrameAnnotater, Observer {
    ...
    synchronized public EventPacket filterPacket(EventPacket in) {
        ...
        for (Object e : in) {
            ...
            KalmanStructure kalman = new KalmanStructure();
            kalman.predict();
            kalman.update();
    ...
    final public class KalmanStructure {
        ...
        // TODO
        // Time
        private int t0;         // Timestamp of previous iteration
        private int ts;         // Latest timestamp
        private float dt;       // Timestep = ts - t0 
        ...
        */
        ...
        private void initData(){
            ...
            processVariance = measurementVariance + 100;  // TODO
            ...
            x[0] = pca.xMean; // Data from PCA
            x[1] = 0; 
            x[2] = pca.yMean;
            x[3] = 0; 

            z[0] = pca.xMean; // the observation
            z[1] = pca.yMean;
