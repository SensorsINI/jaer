 ...
 * @author haza
 */
public class SpatialEvent_BCK extends PolarityEvent {
     ...
     */
    public SpatialEvent_BCK(int timestamp, float value, Spatial type) {
    ...
    public void copyFrom(BasicEvent src) {
        super.copyFrom(src);
        if(src instanceof SpatialEvent_BCK) {
            SpatialEvent_BCK e = (SpatialEvent_BCK) src;
