...
public class FilterLaserline extends EventFilter2D implements FrameAnnotater {
	...
	private void updateBinWeights() {
		...
		if (divisor == 0)
		{
			divisor = 1.0; // avoid divions by 0 (allthough should never happen)
		}
