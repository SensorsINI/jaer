...
public class ApsFrameExtractor extends EventFilter2D
	...
	/**
	 * Returns a double[] buffer of latest displayed frame with adjustments like brightness, contrast, log intensity
	 * conversion, etc.
	...
	/**
	 * @param invertIntensity
	 *            the invertIntensity to set
	 */
	...
	/**
	 * @param showAPSFrameDisplay
	 *            the showAPSFrameDisplay to set
	 */
