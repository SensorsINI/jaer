/*
 * PawTrackerStereoBoard4Label.java
 ...
 * @author rogister
 */
public class PawTrackerStereoBoard4Label extends EventFilter2D implements FrameAnnotater, Observer /*, PreferenceChangeListener*/ {
...
//   Event3D[][] rightRetina3D;
  ...
  //  private float planeAngle=getPrefs().getFloat("PawTrackerStereoBoard4Label.planeAngle",-30.0f);
 //   private float platformAngle=getPrefs().getFloat("PawTrackerStereoBoard4Label.platformAngle",-20.0f);
    
    private float retina_tilt_angle=getPrefs().getFloat("PawTrackerStereoBoard4Label.retina_tilt_angle",0.0f);
    {setPropertyTooltip("retina_tilt_angle","forward tilt angle of the retinae, in degrees");}
    private float retina_height=getPrefs().getFloat("PawTrackerStereoBoard4Label.retina_height",30.0f);
    {setPropertyTooltip("retina_height","height of retina lens, in mm");}
    private float cage_distance=getPrefs().getFloat("PawTrackerStereoBoard4Label.cage_distance",100.0f);
    {setPropertyTooltip("cage_distance","distance between stereoboard center and cage door, in mm");}
    private float cage_door_height=getPrefs().getFloat("PawTrackerStereoBoard4Label.cage_door_height",30.0f);
    {setPropertyTooltip("cage_door_height","height of the cage door, in mm");}
    private float cage_height=getPrefs().getFloat("PawTrackerStereoBoard4Label.cage_height",400.0f);
    {setPropertyTooltip("cage_height","height of the cage, in mm");}
    private float cage_width=getPrefs().getFloat("PawTrackerStereoBoard4Label.cage_width",200.0f);
    {setPropertyTooltip("cage_width","width of the cage, in mm");}
    private float cage_platform_length=getPrefs().getFloat("PawTrackerStereoBoard4Label.cage_platform_length",30.0f);
    ...
    private float cage_base_height=getPrefs().getFloat("PawTrackerStereoBoard4Label.cage_base_height",0.0f);
    {setPropertyTooltip("cage_base_height","ground eleveation, compared to camera, of the cage, in mm");}
    private float cage_door_offset=getPrefs().getFloat("PawTrackerStereoBoard4Label.cage_door_offset",0.0f);
    {setPropertyTooltip("cage_door_offset","offset of the cage's door toward left, in mm");}




     private int zoom3D=getPrefs().getInt("PawTrackerStereoBoard4Label.zoom3D",1);
     private float sensivity=getPrefs().getFloat("PawTrackerStereoBoard4Label.sensivity",1);


 //   private float focal_length=getPrefs().getFloat("PawTrackerStereoBoard4Label.focal_length",6.0f);
//   {setPropertyTooltip("focal_length","focal length in mm");}
//    private float retinae_distance=getPrefs().getFloat("PawTrackerStereoBoard4Label.retinae_distance",100.0f);
//   {setPropertyTooltip("retinae_distance","distance between the two retinae in mm");}
    private float pixel_size=getPrefs().getFloat("PawTrackerStereoBoard4Label.pixel_size",0.04f);
   {setPropertyTooltip("pixel_size","pixel size of retina in mm");}
 //   private float retina_angle=getPrefs().getFloat("PawTrackerStereoBoard4Label.retina_angle",10.0f);
 //  {setPropertyTooltip("retina_angle","angle of rotation of retina in degrees");}
  
    
    
    private int max_finger_clusters=getPrefs().getInt("PawTrackerStereoBoard4Label.max_finger_clusters",10);
    private int grasp_max_elevation=getPrefs().getInt("PawTrackerStereoBoard4Label.grasp_max_elevation",15);
 
    
    
    private float alpha=getPrefs().getFloat("PawTrackerStereoBoard4Label.alpha",0.1f);
    private float intensity=getPrefs().getFloat("PawTrackerStereoBoard4Label.intensity",1);
    
    
 //   private int dispAvgRange=getPrefs().getInt("PawTrackerStereoBoard4Label.dispAvgRange",1);
    
    private int yLeftCorrection=getPrefs().getInt("PawTrackerStereoBoard4Label.yLeftCorrection",0);
    private int yRightCorrection=getPrefs().getInt("PawTrackerStereoBoard4Label.yRightCorrection",0);
    
//    private float yCurveFactor=getPrefs().getFloat("PawTrackerStereoBoard4Label.yCurveFactor",0.1f);
    
    private float valueThreshold=getPrefs().getFloat("PawTrackerStereoBoard4Label.valueThreshold",0);
    private float accValueThreshold=getPrefs().getFloat("PawTrackerStereoBoard4Label.accValueThreshold",0);
 
    
    private float shadowFactor=getPrefs().getFloat("PawTrackerStereoBoard4Label.shadowFactor",0.3f);
//    private float colorizeFactor=getPrefs().getFloat("PawTrackerStereoBoard4Label.colorizeFactor",0.1f);
 //   private int colorizePeriod=getPrefs().getInt("PawTrackerStereoBoard4Label.colorizePeriod",183);
    
    
//    private int zFactor=getPrefs().getInt("PawTrackerStereoBoard4Label.zFactor",1);
 //   private float valueMargin=getPrefs().getFloat("PawTrackerStereoBoard4Label.valueMargin",0.3f);
    
 //   private int disparity_range=getPrefs().getInt("PawTrackerStereoBoard4Label.disparity_range",50);
    
    private int cube_size=getPrefs().getInt("PawTrackerStereoBoard4Label.cube_size",1);
    
   
   
    private int retinaSize=getPrefs().getInt("PawTrackerStereoBoard4Label.retinaSize",128);
    
    private int intensityZoom = getPrefs().getInt("PawTrackerStereoBoard4Label.intensityZoom",2);
    {setPropertyTooltip("intensityZoom","zoom for tracker window");}
    
    
    private float brightness=getPrefs().getFloat("PawTrackerStereoBoard4Label.brightness",1f);
    {setPropertyTooltip("brightness","brightness or increase of display for accumulated values");}
    
    
  //  private float correctLeftAngle=getPrefs().getFloat("PawTrackerStereoBoard4Label.correctLeftAngle",0.0f);
  //  private float correctRightAngle=getPrefs().getFloat("PawTrackerStereoBoard4Label.correctRightAngle",0.0f);
    
    
 //   private boolean useFastMatching = getPrefs().getBoolean("PawTrackerStereoBoard4Label.useFastMatching",true);
 //   private boolean showYColor = getPrefs().getBoolean("PawTrackerStereoBoard4Label.showYColor",false);
 //   private boolean showXColor = getPrefs().getBoolean("PawTrackerStereoBoard4Label.showXColor",false);
 //   private boolean showZColor = getPrefs().getBoolean("PawTrackerStereoBoard4Label.showZColor",false);
 //   private boolean showShadows = getPrefs().getBoolean("PawTrackerStereoBoard4Label.showShadows",false);
 //   private boolean showCorner = getPrefs().getBoolean("PawTrackerStereoBoard4Label.showCorner",false);
    
 //   private boolean highlightDecay = getPrefs().getBoolean("PawTrackerStereoBoard4Label.highlightDecay",false);
    
    
    
//    private boolean correctY = getPrefs().getBoolean("PawTrackerStereoBoard4Label.correctY",false);
 //   private boolean useFilter = getPrefs().getBoolean("PawTrackerStereoBoard4Label.useFilter",false);
    
 //   private boolean useLarge = getPrefs().getBoolean("PawTrackerStereoBoard4Label.useLarge",false);
    
    
    private boolean showFingers = getPrefs().getBoolean("PawTrackerStereoBoard4Label.showFingers",true);
    private boolean showFingersRange = getPrefs().getBoolean("PawTrackerStereoBoard4Label.showFingersRange",false);

 //   private boolean showFingerTips = getPrefs().getBoolean("PawTrackerStereoBoard4Label.showFingerTips",true);
    
    private boolean showZones = getPrefs().getBoolean("PawTrackerStereoBoard4Label.showZones",false);
//    private boolean showAll = getPrefs().getBoolean("PawTrackerStereoBoard4Label.showAll",true);
    // show intensity inside shape
    
 //   private boolean showAcc = getPrefs().getBoolean("PawTrackerStereoBoard4Label.showAcc",false);
   private boolean showOnlyAcc = getPrefs().getBoolean("PawTrackerStereoBoard4Label.showOnlyAcc",false);
 //   private boolean showDecay = getPrefs().getBoolean("PawTrackerStereoBoard4Label.showDecay",false);
    
    
    private boolean scaleAcc = getPrefs().getBoolean("PawTrackerStereoBoard4Label.scaleAcc",true);
    
    private boolean showCage = getPrefs().getBoolean("PawTrackerStereoBoard4Label.showCage",true);
  //  private boolean showFrame = getPrefs().getBoolean("PawTrackerStereoBoard4Label.showFrame",true);
    private boolean show2DWindow = getPrefs().getBoolean("PawTrackerStereoBoard4Label.show2DWindow",true);
    private boolean show3DWindow = getPrefs().getBoolean("PawTrackerStereoBoard4Label.show3DWindow",true);
  //  private boolean showPlayer = getPrefs().getBoolean("PawTrackerStereoBoard4Label.showPlayer",true);
  //  private boolean showScore = getPrefs().getBoolean("PawTrackerStereoBoard4Label.showScore",false);
    private boolean showRetina = getPrefs().getBoolean("PawTrackerStereoBoard4Label.showRetina",false);
  
    private boolean trackFingers = getPrefs().getBoolean("PawTrackerStereoBoard4Label.trackFingers",false);
  
    
    //  private boolean showShapePoints = getPrefs().getBoolean("PawTrackerStereoBoard4Label.showShapePoints",true);
    //   private boolean showFingerPoints = getPrefs().getBoolean("PawTrackerStereoBoard4Label.showFingerPoints",true);
    
    
    
    //   private boolean showShape = getPrefs().getBoolean("PawTrackerStereoBoard4Label.showShape",true);
    private boolean showRLColors = getPrefs().getBoolean("PawTrackerStereoBoard4Label.showRLColors",false);
    private boolean showAxes = getPrefs().getBoolean("PawTrackerStereoBoard4Label.showAxes",true);
...
//    private boolean showCorrectionMatrix = getPrefs().getBoolean("PawTrackerStereoBoard4Label.showCorrectionMatrix",false);
//    private boolean showCorrectionGradient = getPrefs().getBoolean("PawTrackerStereoBoard4Label.showCorrectionGradient",false);
    
//    private boolean showRight = getPrefs().getBoolean("PawTrackerStereoBoard4Label.showRight",false);
    
//    private boolean showPalm = getPrefs().getBoolean("PawTrackerStereoBoard4Label.showPalm",false);
    
//    private boolean showSkeletton = getPrefs().getBoolean("PawTrackerStereoBoard4Label.showSkeletton",false);
//    private boolean showSecondFilter = getPrefs().getBoolean("PawTrackerStereoBoard4Label.showSecondFilter",false);
//    private boolean showTopography = getPrefs().getBoolean("PawTrackerStereoBoard4Label.showTopography",false);
    
    
//    private boolean restart=getPrefs().getBoolean("PawTrackerStereoBoard4Label.restart",false);
    
    private boolean resetPawTracking=getPrefs().getBoolean("PawTrackerStereoBoard4Label.resetPawTracking",false);
    private boolean resetClusters=getPrefs().getBoolean("PawTrackerStereoBoard4Label.resetClusters",false);
  
    
    
//    private boolean validateParameters=getPrefs().getBoolean("PawTrackerStereoBoard4Label.validateParameters",false);
    
    private float event_strength=getPrefs().getFloat("PawTrackerStereoBoard4Label.event_strength",2f);
    
    private float decayTimeLimit=getPrefs().getFloat("PawTrackerStereoBoard4Label.decayTimeLimit",10000);
    {setPropertyTooltip("decayTimeLimit","[microsec (us)] for decaying accumulated events");}
    private boolean decayOn = getPrefs().getBoolean("PawTrackerStereoBoard4Label.decayOn",false);
    {setPropertyTooltip("decayOn","switch on/off decaying accumulated image");}
    
    
 //   private boolean notCrossing = getPrefs().getBoolean("PawTrackerStereoBoard4Label.notCrossing",false);
    
    
    private float finger_mix=getPrefs().getFloat("PawTrackerStereoBoard4Label.finger_mix",0.5f);
    private int finger_surround=getPrefs().getInt("PawTrackerStereoBoard4Label.finger_surround",10);
    
    private boolean useGroups = getPrefs().getBoolean("PawTrackerStereoBoard4Label.useGroups",true);
    
  //  private boolean goThroughMode = getPrefs().getBoolean("PawTrackerStereoBoard4Label.goThroughMode",false);
//    private boolean useCorrections = getPrefs().getBoolean("PawTrackerStereoBoard4Label.useCorrections",true);
    private int tracker_lifeTime=getPrefs().getInt("PawTrackerStereoBoard4Label.tracker_lifeTime",10000);
    private int tracker_prelifeTime=getPrefs().getInt("PawTrackerStereoBoard4Label.tracker_prelifeTime",1000);
    private int tracker_viable_nb_events=getPrefs().getInt("PawTrackerStereoBoard4Label.tracker_viable_nb_events",100);
   
       
    private float expansion_mix=getPrefs().getFloat("PawTrackerStereoBoard4Label.expansion_mix",0.5f);
    private float trackerSubsamplingDistance=getPrefs().getFloat("PawTrackerStereoBoard4Label.trackerSubsamplingDistance",10);//cm?
    private boolean recordTrackerData = getPrefs().getBoolean("PawTrackerStereoBoard4Label.recordTrackerData",false);
    private boolean logDataEnabled = getPrefs().getBoolean("PawTrackerStereoBoard4Label.logDataEnabled",false);
 
    
 //   private float plane_tracker_mix=getPrefs().getFloat("PawTrackerStereoBoard4Label.plane_tracker_mix",0.5f);
 //   private boolean trackZPlane = getPrefs().getBoolean("PawTrackerStereoBoard4Label.trackZPlane",false);
 
    private boolean detectGrasp = getPrefs().getBoolean("PawTrackerStereoBoard4Label.detectGrasp",false);
    private boolean checkNose = getPrefs().getBoolean("PawTrackerStereoBoard4Label.checkNose",false);
 
    private int start_min_events=getPrefs().getInt("PawTrackerStereoBoard4Label.start_min_events",10000);
    private int start_z_displacement=getPrefs().getInt("PawTrackerStereoBoard4Label.start_z_displacement",100);
    private int grasp_timelength_min=getPrefs().getInt("PawTrackerStereoBoard4Label.grasp_timelength_min",200000);
 
    // epipolar
  //  private boolean correctEpipolar = getPrefs().getBoolean("PawTrackerStereoBoard4Label.correctEpipolar",true);
    private int recordUpTo=0; //getPrefs().getInt("PawTrackerStereoBoard4Label.recordUpTo",0);
 
    private boolean autoRecord = getPrefs().getBoolean("PawTrackerStereoBoard4Label.autoRecord",false);


    private float event3DLifeTime=getPrefs().getFloat("PawTrackerStereoBoard4Label.event3DLifeTime",100);
    {setPropertyTooltip("event3DLifeTime","life time of event for 3D display, in ms");}


    private int max3DEvents=getPrefs().getInt("PawTrackerStereoBoard4Label.max3DEvents",10000);

//    private boolean throwAwayEvents = getPrefs().getBoolean("PawTrackerStereoBoard4Label.throwAwayEvents",false);
    ...
    int currentStartRight = 0;
    Event3D[] current3DEventsRight;
...
//    protected FingerCluster[] fingers = new FingerCluster[MAX_NB_FINGERS];
    ...
    public PawTrackerStereoBoard4Label(AEChip chip) {
        super(chip);
        this.chip=chip;
    ...
    private void resetPawTracker(){
     ...
     //   System.out.println("reset PawTrackerStereoBoard4Label reset");
                    ...
                    if (nextGroup.disparity != -1) {
                        ...
                        if (currentTime - nextGroup.time < decayTimeLimit) {
                           // draw3DGroup(gl, nextGroup, matchedGroup);
                            new3DEvent(method,nextGroup, matchedGroup);
  ...
  //      if (showPlayer) playerRecorderFrame.repaint();
    ...
    private synchronized void compute3DParameters(){
        ...
        // WE CHOOSE SCALE AS : 1 3D-pixel per retina pixel size
         ...
         current3DEventsRight = new Event3D[max3DEvents];
...
//        setValidateParameters(false); //should update gui
   ...
   protected Event3D create3DEvent( GroupLabel nextGroup, GroupLabel matchedGroup){
    ...
    protected Event3D create3DEventRight( GroupLabel nextGroup, GroupLabel matchedGroup){
     // create new 3D event
     Event3D newEvent = null;
    ...
    // Point p = triangulatePoint(LEFT, (nextGroup.xmin+nextGroup.xmax)/2, nextGroup.y, (matchedGroup.xmin+matchedGroup.xmax)/2, matchedGroup.y);
     ...
     Point p = triangulatePoint(RIGHT, nextGroup.xmin, nextGroup.y, matchedGroup.xmin, matchedGroup.y);



     if(p.z<(max_distance*scaleFactor)){
         newEvent = current3DEventsRight[currentIndexRight];
         int time = nextGroup.time;
         int type = 1;

         if (newEvent==null){
           newEvent = new Event3D(Math.round(p.x), Math.round(p.y), Math.round(p.z), type, time);
           current3DEventsRight[currentIndexRight] = newEvent;
         } else {
           newEvent.changeTo(Math.round(p.x), Math.round(p.y), Math.round(p.z), type, time);
         }
         newEvent.d=nextGroup.value;
         ...
         currentIndexRight++;
         // check ring buffer
         if(currentIndexRight>=max3DEvents){
               currentIndexRight=0;
           }
           if(currentIndexRight==currentStartRight){
               currentStartRight++;
               if(currentIndexRight==max3DEvents){
                  currentStartRight=0;
               }
  ...
  protected Event3D create3DEvent( int x1, int y1, int x2, int y2, int time, int type ){
   ...
   //  if(p.z>0){
         newEvent = current3DEventsRight[currentIndex];

         if (newEvent==null){
           newEvent = new Event3D(Math.round(p.x), Math.round(p.y), Math.round(p.z), type, time);
           current3DEventsRight[currentIndex] = newEvent;
         } else {
           newEvent.changeTo(Math.round(p.x), Math.round(p.y), Math.round(p.z), type, time);
         }
...
//
    ...
    synchronized private void draw3DDisparityGroups(GL gl, EventPoint leadPoints[][], int method) {
            ...
            for (int y = 0; y < retinaSize; y++) {
                ...
                while (nextGroup != null) {
                    ...
                    if (nextGroup.disparity != -1) {
                        ...
                        if (currentTime - nextGroup.time < decayTimeLimit) {
                            if (!drawGroupFlat){
                                draw3DGroupLeft(gl, nextGroup, matchedGroup);
                            } else {
                ...
                while (nextGroup != null) {
                    ...
                    if (nextGroup.disparity != -1) {
                        ...
                        if (currentTime - nextGroup.time > decayTimeLimit) {
                            ...
                            if (!drawGroupFlat){
                                draw3DGroupRight(gl, nextGroup, matchedGroup);
                            } else {
                                draw3DGroup2(gl, nextGroup, matchedGroup);
                            }
         ...
         *
         */
       private void draw3DGroupRight( GL gl,  GroupLabel nextGroup, GroupLabel matchedGroup){
            if(nextGroup==null || matchedGroup==null) return;
            Point p1 = triangulatePoint(RIGHT, nextGroup.xmin, nextGroup.y, matchedGroup.xmin, matchedGroup.y);
            Point p2 = triangulatePoint(RIGHT, nextGroup.xmax, nextGroup.y, matchedGroup.xmax, matchedGroup.y);

            shadowCubeLine(gl, p1.x, p1.y, p1.z, p2.x, p2.y, p2.z, cube_size, 1, 1, 1, alpha, shadowFactor);
       }
       private void draw3DGroupLeft( GL gl,  GroupLabel nextGroup, GroupLabel matchedGroup){
            if(nextGroup==null || matchedGroup==null) return;
      ...
      private void draw3DGroup2( GL gl, GroupLabel nextGroup, GroupLabel matchedGroup){
       ...
       private void draw3DGroup( GL gl, GroupLabel nextGroup, GroupLabel matchedGroup,float r, float g, float b){
            ...
            shadowCubeLine(gl, p1.x, p1.y, p1.z, p2.x, p2.y, p2.z, cube_size, r, g, b, 1, 0);
      ...
      private void draw3DGroup2( GL gl, GroupLabel nextGroup, GroupLabel matchedGroup,float r, float g, float b){
            ...
            shadowCubeLine(gl, p1.x, p1.y, p0.z, p2.x, p2.y, p0.z, cube_size, r, g, b, 1, 0);
...
//    void drawGLCluster(int x1, int y1, int x2, int y2)
    ...
    public synchronized void setLogDataEnabled(boolean logDataEnabled) {
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Label.logDataEnabled",logDataEnabled);
    ...
    public void setDecayTimeLimit(float decayTimeLimit) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard4Label.decayTimeLimit",decayTimeLimit);
    }
    ...
    public void setIntensityZoom(int intensityZoom) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard4Label.intensityZoom",intensityZoom);
    }
    ...
    public void setEvent_strength(float event_strength) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard4Label.event_strength",event_strength);
    }
    ...
    public void setResetPawTracking(boolean resetPawTracking) {
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Label.resetPawTracking",resetPawTracking);
    ...
    public void setResetClusters(boolean resetClusters) {
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Label.resetClusters",resetClusters);
...
//
//        getPrefs().putBoolean("PawTrackerStereoBoard4Label.restart",restart);
//
//    }
...
//        
//        getPrefs().putBoolean("PawTrackerStereoBoard4Label.validateParameters",validateParameters);
//        
//    }
...
//
//        getPrefs().putBoolean("PawTrackerStereoBoard4Label.showCorrectionGradient",showCorrectionGradient);
//    }
...
//
//        getPrefs().putBoolean("PawTrackerStereoBoard4Label.showCorrectionMatrix",showCorrectionMatrix);
//    }
...
//        
//        getPrefs().putBoolean("PawTrackerStereoBoard4Label.showSecondFilter",showSecondFilter);
//    }
...
//    
    ...
    public void setScaleAcc(boolean scaleAcc){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Label.scaleAcc",scaleAcc);
    }
...
//
//
//        getPrefs().putBoolean("PawTrackerStereoBoard4Label.showAcc",showAcc);
//    }
...
//    }
    ...
    public void setShowOnlyAcc(boolean showOnlyAcc){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Label.showOnlyAcc",showOnlyAcc);
    }
...
//
//        getPrefs().putBoolean("PawTrackerStereoBoard4Label.showDecay",showDecay);
//    }
...
//
//        getPrefs().putBoolean("PawTrackerStereoBoard4Label.useFilter",useFilter);
//    }
...
//    }
    ...
    public void setDecayOn(boolean decayOn){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Label.decayOn",decayOn);
    }
...
//        
//        getPrefs().putBoolean("PawTrackerStereoBoard4Label.showFrame",showFrame);
//    }
...
//    }
    ...
    public void setShowCage(boolean showCage){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Label.showCage",showCage);
    }
    ...
    public void setShowRetina(boolean showRetina){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Label.showRetina",showRetina);
    }
    ...
    public void setShow2DWindow(boolean show2DWindow){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Label.show2DWindow",show2DWindow);
    }
    public boolean isShow2DWindow(){
      ...
      public void setShow3DWindow(boolean show3DWindow){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Label.show3DWindow",show3DWindow);
    }
...
//
//        getPrefs().putBoolean("PawTrackerStereoBoard4Label.showPlayer",showPlayer);
//    }
...
//        
//        getPrefs().putBoolean("PawTrackerStereoBoard4Label.showScore",showScore);
//    }
...
//
//        getPrefs().putBoolean("PawTrackerStereoBoard4Label.showRight",showRight);
//    }
...
//
    ...
    public void setShowFingers(boolean showFingers){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Label.showFingers",showFingers);
    }
    public boolean isShowFingers(){
     ...
     public void setShowFingersRange(boolean showFingersRange){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Label.showFingersRange",showFingersRange);
    }
...
//        
//        getPrefs().putBoolean("PawTrackerStereoBoard4Label.showFingerTips",showFingerTips);
//    }
...
//    }
    ...
    public void setShowZones(boolean showZones){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Label.showZones",showZones);
    }
...
//
//        getPrefs().putBoolean("PawTrackerStereoBoard4Label.showAll",showAll);
//    }
...
//
//        getPrefs().putBoolean("PawTrackerStereoBoard4Label.useFastMatching",useFastMatching);
//    }
...
//    }
    ...
    public void setShowRLColors(boolean showRLColors){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Label.showRLColors",showRLColors);
    }
    ...
    public void setShowAxes(boolean showAxes){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Label.showAxes",showAxes);
    }
    ...
    public void setLowFilter_radius(int lowFilter_radius) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard4Label.lowFilter_radius",lowFilter_radius);
    }
    ...
    public void setLowFilter_density(int lowFilter_density) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard4Label.lowFilter_density",lowFilter_density);
    }
    ...
    public void setLowFilter_threshold(float lowFilter_threshold) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard4Label.lowFilter_threshold",lowFilter_threshold);
    }
//    
...
//        
//        getPrefs().putInt("PawTrackerStereoBoard4Label.lowFilter_radius2",lowFilter_radius2);
//    }
//    
...
//        
//        getPrefs().putInt("PawTrackerStereoBoard4Label.lowFilter_density2",lowFilter_density2);
//    }
    ...
    public void setBrightness(float brightness) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard4Label.brightness",brightness);
    }
...
//        
//        getPrefs().putFloat("PawTrackerStereoBoard4Label.planeAngle",planeAngle);
//    }
...
//        
//        getPrefs().putFloat("PawTrackerStereoBoard4Label.platformAngle",platformAngle);
//    }
...
//        this.alpha = alpha;
//
//        getPrefs().putFloat("PawTrackerStereoBoard4Label.alpha",alpha);
//    }
...
//    }
    public void setIntensity(float intensity) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard4Label.intensity",intensity);
    }
...
//        
//        getPrefs().putInt("PawTrackerStereoBoard4Label.dispAvgRange",dispAvgRange);
//    }
...
//    }
    ...
    public void setValueThreshold(float valueThreshold) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard4Label.valueThreshold",valueThreshold);
    }
...
//
//        getPrefs().putFloat("PawTrackerStereoBoard4Label.accValueThreshold",accValueThreshold);
//    }
...
//    }
    ...
    public void setGrasp_max_elevation(int grasp_max_elevation) {
        ...
        compute3DZones();
        getPrefs().putInt("PawTrackerStereoBoard4Label.grasp_max_elevation",grasp_max_elevation);
    }
    ...
    public void setMax_finger_clusters(int max_finger_clusters) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard4Label.max_finger_clusters",max_finger_clusters);
    }
    ...
    public void setCage_distance(float cage_distance) {
        ...
        compute3DZones();
        getPrefs().putFloat("PawTrackerStereoBoard4Label.cage_distance",cage_distance);
    }
    public float getMax_distance() {
      ...
      public void setMax_distance(float max_distance) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard4Label.max_distance",max_distance);
    }
    ...
    public void setRetina_tilt_angle(float retina_tilt_angle) {
        ...
        compute3DZones();
        getPrefs().putFloat("PawTrackerStereoBoard4Label.retina_tilt_angle",retina_tilt_angle);
    }
    
    public void setRetina_height(float retina_height) {
        this.retina_height = retina_height;
        compute3DZones();
        getPrefs().putFloat("PawTrackerStereoBoard4Label.retina_height",retina_height);
    }
    ...
    public void setCage_base_height(float cage_base_height) {
        ...
        compute3DZones();
        getPrefs().putFloat("PawTrackerStereoBoard4Label.cage_base_height",cage_base_height);
    }
    public float getCage_base_height() {
     ...
     public void setCage_door_offset(float cage_door_offset) {
        ...
        compute3DZones();
        getPrefs().putFloat("PawTrackerStereoBoard4Label.cage_door_offset",cage_door_offset);
    }
    ...
    public void setCage_door_height(float cage_door_height) {
        ...
        compute3DZones();
        getPrefs().putFloat("PawTrackerStereoBoard4Label.cage_door_height",cage_door_height);
    }
    ...
    public void setCage_height(float cage_height) {
        ...
        compute3DZones();
        getPrefs().putFloat("PawTrackerStereoBoard4Label.cage_height",cage_height);
    }
    ...
    public void setCage_width(float cage_width) {
        ...
        compute3DZones();
        getPrefs().putFloat("PawTrackerStereoBoard4Label.cage_width",cage_width);
    }
    ...
    public void setCage_platform_length(float cage_platform_length) {
        ...
        compute3DZones();
        getPrefs().putFloat("PawTrackerStereoBoard4Label.cage_platform_length",cage_platform_length);
    }
    ...
    public void setCage_door_width(float cage_door_width) {
        ...
        compute3DZones();
        getPrefs().putFloat("PawTrackerStereoBoard4Label.cage_door_width",cage_door_width);
    }
...
//
//        getPrefs().putInt("PawTrackerStereoBoard4Label.yLeftCorrection",yLeftCorrection);
//    }
...
//
//        getPrefs().putInt("PawTrackerStereoBoard4Label.yRightCorrection",yRightCorrection);
//    }
...
//
//        getPrefs().putFloat("PawTrackerStereoBoard4Label.yCurveFactor",yCurveFactor);
//    }
...
//
//        getPrefs().putFloat("PawTrackerStereoBoard4Label.colorizeFactor",colorizeFactor);
//    }
...
//
//        getPrefs().putFloat("PawTrackerStereoBoard4Label.shadowFactor",shadowFactor);
//    }
...
//
//        getPrefs().putInt("PawTrackerStereoBoard4Label.zFactor",zFactor);
//    }
...
//
//        getPrefs().putFloat("PawTrackerStereoBoard4Label.valueMargin",valueMargin);
//    }
...
//
//        getPrefs().putFloat("PawTrackerStereoBoard4Label.correctLeftAngle",correctLeftAngle);
//    }
...
//
//        getPrefs().putFloat("PawTrackerStereoBoard4Label.correctRightAngle",correctRightAngle);
//    }
...
//
//        getPrefs().putInt("PawTrackerStereoBoard4Label.colorizePeriod",colorizePeriod);
//    }
...
//
//        getPrefs().putBoolean("PawTrackerStereoBoard4Label.highlightDecay",highlightDecay);
//    }
...
//
//        getPrefs().putBoolean("PawTrackerStereoBoard4Label.showZColor",showZColor);
//    }
...
//
//        getPrefs().putBoolean("PawTrackerStereoBoard4Label.showYColor",showYColor);
//    }
...
//
//        getPrefs().putBoolean("PawTrackerStereoBoard4Label.showXColor",showXColor);
//    }
...
//
    ...
    public void setTrackFingers(boolean trackFingers){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Label.trackFingers",trackFingers);
    }
...
//        
//        getPrefs().putBoolean("PawTrackerStereoBoard4Label.showShadows",showShadows);
//    }
...
//        
//        getPrefs().putBoolean("PawTrackerStereoBoard4Label.showCorner",showCorner);
//    }
...
//
//        getPrefs().putBoolean("PawTrackerStereoBoard4Label.correctY",correctY);
//    }
...
//
    public void setCube_size(int cube_size) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard4Label.cube_size",cube_size);
    }
...
//        
//        getPrefs().putInt("PawTrackerStereoBoard4Label.disparity_range",disparity_range);
//    }
...
//
//        getPrefs().putBoolean("PawTrackerStereoBoard4Label.notCrossing",notCrossing);
//    }
...
//    }
    ...
    public void setFinger_mix(float finger_mix) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard4Label.finger_mix",finger_mix);
    }
    ...
    public void setExpansion_mix(float expansion_mix) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard4Label.expansion_mix",expansion_mix);
    }
...
//        getPrefs().putFloat("PawTrackerStereoBoard4Label.plane_tracker_mix",plane_tracker_mix);
//    }
    ...
    public void setTrackerSubsamplingDistance(float trackerSubsamplingDistance) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard4Label.trackerSubsamplingDistance",trackerSubsamplingDistance);
    }
    ...
    public void setFinger_surround(int finger_surround) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard4Label.finger_surround",finger_surround);
    }
    ...
    public void setTracker_lifeTime(int tracker_lifeTime) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard4Label.tracker_lifeTime",tracker_lifeTime);
    }
    ...
    public void setTracker_prelifeTime(int tracker_prelifeTime) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard4Label.tracker_prelifeTime",tracker_prelifeTime);
    }
    ...
    public void setTracker_viable_nb_events(int tracker_viable_nb_events) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard4Label.tracker_viable_nb_events",tracker_viable_nb_events);
    }
    ...
    public void setUseGroups(boolean useGroups){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Label.useGroups",useGroups);
    }
...
//        
//        getPrefs().putBoolean("PawTrackerStereoBoard4Label.goThroughMode",goThroughMode);
//    }
...
//
//        getPrefs().putBoolean("PawTrackerStereoBoard4Label.useCorrections",useCorrections);
//    }
...
//        getPrefs().putFloat("PawTrackerStereoBoard4Label.focal_length",focal_length);
//        compute3DParameters();
//    }
//
...
//        getPrefs().putFloat("PawTrackerStereoBoard4Label.retinae_distance",retinae_distance);
//        compute3DParameters();
//    }
...
//        getPrefs().putFloat("PawTrackerStereoBoard4Label.pixel_size",pixel_size);
//        compute3DParameters();
//    }
...
//        getPrefs().putFloat("PawTrackerStereoBoard4Label.retina_angle",retina_angle);
//        compute3DParameters();
//    }
...
//    }
    ...
    public void setRecordTrackerData(boolean recordTrackerData){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Label.recordTrackerData",recordTrackerData);
    }
...
//        
//        getPrefs().putBoolean("PawTrackerStereoBoard4Label.trackZPlane",trackZPlane);
//    }
...
//    }
    ...
    public void setDetectGrasp(boolean detectGrasp){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Label.detectGrasp",detectGrasp);
    }
    ...
    public void setCheckNose(boolean checkNose){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Label.checkNose",checkNose);
    }
   ...
   public void setMax3DEvents(int max3DEvents) {
        ...
        compute3DParameters();
        getPrefs().putInt("PawTrackerStereoBoard4Label.max3DEvents",max3DEvents);
    }
    ...
    public void setStart_z_displacement(int start_z_displacement) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard4Label.start_z_displacement",start_z_displacement);
    }
    ...
    public void setStart_min_events(int start_min_events) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard4Label.start_min_events",start_min_events);
    }
    ...
    public void setGrasp_timelength_min(int grasp_timelength_min) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard4Label.grasp_timelength_min",grasp_timelength_min);
    }
    ...
    public void setRecordUpTo(int recordUpTo) {
       ...
       // getPrefs().putInt("PawTrackerStereoBoard4Label.recordUpTo",recordUpTo);
    }
    ...
    public void setAutoRecord(boolean autoRecord){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Label.autoRecord",autoRecord);
    }
    ...
    public void setEvent3DLifeTime(float event3DLifeTime) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard4Label.event3DLifeTime",event3DLifeTime);
...
//        
//        getPrefs().putBoolean("PawTrackerStereoBoard4Label.throwAwayEvents",throwAwayEvents);
//    }
    ...
    public void setzoom3D(int zoom3D) {
        this.zoom3D = zoom3D;
        compute3DParameters();
       getPrefs().putInt("PawTrackerStereoBoard4Label.zoom3D",zoom3D);
    }
