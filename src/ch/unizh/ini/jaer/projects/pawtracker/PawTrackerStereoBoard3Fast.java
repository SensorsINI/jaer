/*
 * PawTrackerStereoBoard3Fast.java
 ...
 * @author rogister
 */
public class PawTrackerStereoBoard3Fast extends EventFilter2D implements FrameAnnotater, Observer /*, PreferenceChangeListener*/ {
...
//   Event3D[][] rightRetina3D;
  ...
  //  private float planeAngle=getPrefs().getFloat("PawTrackerStereoBoard3Fast.planeAngle",-30.0f);
 //   private float platformAngle=getPrefs().getFloat("PawTrackerStereoBoard3Fast.platformAngle",-20.0f);
    
    private float retina_tilt_angle=getPrefs().getFloat("PawTrackerStereoBoard3Fast.retina_tilt_angle",0.0f);
    {setPropertyTooltip("retina_tilt_angle","forward tilt angle of the retinae, in degrees");}
    private float retina_height=getPrefs().getFloat("PawTrackerStereoBoard3Fast.retina_height",30.0f);
    {setPropertyTooltip("retina_height","height of retina lens, in mm");}
    private float cage_distance=getPrefs().getFloat("PawTrackerStereoBoard3Fast.cage_distance",100.0f);
    {setPropertyTooltip("cage_distance","distance between stereoboard center and cage door, in mm");}
    private float cage_door_height=getPrefs().getFloat("PawTrackerStereoBoard3Fast.cage_door_height",30.0f);
    {setPropertyTooltip("cage_door_height","height of the cage door, in mm");}
    private float cage_height=getPrefs().getFloat("PawTrackerStereoBoard3Fast.cage_height",400.0f);
    {setPropertyTooltip("cage_height","height of the cage, in mm");}
    private float cage_width=getPrefs().getFloat("PawTrackerStereoBoard3Fast.cage_width",200.0f);
    {setPropertyTooltip("cage_width","width of the cage, in mm");}
    private float cage_platform_length=getPrefs().getFloat("PawTrackerStereoBoard3Fast.cage_platform_length",30.0f);
    ...
    private float cage_door_offset=getPrefs().getFloat("PawTrackerStereoBoard3Fast.cage_door_offset",0.0f);
    {setPropertyTooltip("cage_door_offset","offset of the cage's door toward left, in mm");}




     private int zoom3D=getPrefs().getInt("PawTrackerStereoBoard3Fast.zoom3D",1);
    

 //   private float focal_length=getPrefs().getFloat("PawTrackerStereoBoard3Fast.focal_length",6.0f);
//   {setPropertyTooltip("focal_length","focal length in mm");}
//    private float retinae_distance=getPrefs().getFloat("PawTrackerStereoBoard3Fast.retinae_distance",100.0f);
//   {setPropertyTooltip("retinae_distance","distance between the two retinae in mm");}
    private float pixel_size=getPrefs().getFloat("PawTrackerStereoBoard3Fast.pixel_size",0.04f);
   {setPropertyTooltip("pixel_size","pixel size of retina in mm");}
 //   private float retina_angle=getPrefs().getFloat("PawTrackerStereoBoard3Fast.retina_angle",10.0f);
 //  {setPropertyTooltip("retina_angle","angle of rotation of retina in degrees");}
  
    
    
    private int max_finger_clusters=getPrefs().getInt("PawTrackerStereoBoard3Fast.max_finger_clusters",10);
    private int grasp_max_elevation=getPrefs().getInt("PawTrackerStereoBoard3Fast.grasp_max_elevation",15);
 
    
    
    private float alpha=getPrefs().getFloat("PawTrackerStereoBoard3Fast.alpha",0.1f);
    private float intensity=getPrefs().getFloat("PawTrackerStereoBoard3Fast.intensity",1);
    
    
 //   private int dispAvgRange=getPrefs().getInt("PawTrackerStereoBoard3Fast.dispAvgRange",1);
    
    private int yLeftCorrection=getPrefs().getInt("PawTrackerStereoBoard3Fast.yLeftCorrection",0);
    private int yRightCorrection=getPrefs().getInt("PawTrackerStereoBoard3Fast.yRightCorrection",0);
    
//    private float yCurveFactor=getPrefs().getFloat("PawTrackerStereoBoard3Fast.yCurveFactor",0.1f);
    
    private float valueThreshold=getPrefs().getFloat("PawTrackerStereoBoard3Fast.valueThreshold",0);
    private float accValueThreshold=getPrefs().getFloat("PawTrackerStereoBoard3Fast.accValueThreshold",0);
 
    
    private float shadowFactor=getPrefs().getFloat("PawTrackerStereoBoard3Fast.shadowFactor",0.3f);
//    private float colorizeFactor=getPrefs().getFloat("PawTrackerStereoBoard3Fast.colorizeFactor",0.1f);
 //   private int colorizePeriod=getPrefs().getInt("PawTrackerStereoBoard3Fast.colorizePeriod",183);
    
    
//    private int zFactor=getPrefs().getInt("PawTrackerStereoBoard3Fast.zFactor",1);
 //   private float valueMargin=getPrefs().getFloat("PawTrackerStereoBoard3Fast.valueMargin",0.3f);
    
 //   private int disparity_range=getPrefs().getInt("PawTrackerStereoBoard3Fast.disparity_range",50);
    
    private int cube_size=getPrefs().getInt("PawTrackerStereoBoard3Fast.cube_size",1);
    
   
   
    private int retinaSize=getPrefs().getInt("PawTrackerStereoBoard3Fast.retinaSize",128);
    
    private int intensityZoom = getPrefs().getInt("PawTrackerStereoBoard3Fast.intensityZoom",2);
    {setPropertyTooltip("intensityZoom","zoom for tracker window");}
    
    
    private float brightness=getPrefs().getFloat("PawTrackerStereoBoard3Fast.brightness",1f);
    {setPropertyTooltip("brightness","brightness or increase of display for accumulated values");}
    
    
  //  private float correctLeftAngle=getPrefs().getFloat("PawTrackerStereoBoard3Fast.correctLeftAngle",0.0f);
  //  private float correctRightAngle=getPrefs().getFloat("PawTrackerStereoBoard3Fast.correctRightAngle",0.0f);
    
    
 //   private boolean useFastMatching = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.useFastMatching",true);
 //   private boolean showYColor = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.showYColor",false);
 //   private boolean showXColor = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.showXColor",false);
 //   private boolean showZColor = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.showZColor",false);
 //   private boolean showShadows = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.showShadows",false);
 //   private boolean showCorner = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.showCorner",false);
    
 //   private boolean highlightDecay = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.highlightDecay",false);
    
    
    
//    private boolean correctY = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.correctY",false);
 //   private boolean useFilter = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.useFilter",false);
    
 //   private boolean useLarge = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.useLarge",false);
    
    
    private boolean showFingers = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.showFingers",true);
    private boolean showFingersRange = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.showFingersRange",false);

 //   private boolean showFingerTips = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.showFingerTips",true);
    
    private boolean showZones = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.showZones",false);
//    private boolean showAll = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.showAll",true);
    // show intensity inside shape
    
 //   private boolean showAcc = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.showAcc",false);
   private boolean showOnlyAcc = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.showOnlyAcc",false);
 //   private boolean showDecay = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.showDecay",false);
    
    
    private boolean scaleAcc = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.scaleAcc",true);
    
    private boolean showCage = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.showCage",true);
  //  private boolean showFrame = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.showFrame",true);
  //  private boolean show2DWindow = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.show2DWindow",true);
    private boolean show3DWindow = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.show3DWindow",true);
  //  private boolean showPlayer = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.showPlayer",true);
  //  private boolean showScore = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.showScore",false);
    private boolean showRetina = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.showRetina",false);
  
    private boolean trackFingers = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.trackFingers",false);
  
    
    //  private boolean showShapePoints = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.showShapePoints",true);
    //   private boolean showFingerPoints = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.showFingerPoints",true);
    
    
    
    //   private boolean showShape = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.showShape",true);
    private boolean showRLColors = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.showRLColors",false);
    private boolean showAxes = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.showAxes",true);
    
    
    private int lowFilter_radius=getPrefs().getInt("PawTrackerStereoBoard3Fast.lowFilter_radius",3);
    private int lowFilter_density=getPrefs().getInt("PawTrackerStereoBoard3Fast.lowFilter_density",17);
    private float lowFilter_threshold=getPrefs().getFloat("PawTrackerStereoBoard3Fast.lowFilter_threshold",0);
    
  //  private int lowFilter_radius2=getPrefs().getInt("PawTrackerStereoBoard3Fast.lowFilter_radius2",10);
 //   private int lowFilter_density2=getPrefs().getInt("PawTrackerStereoBoard3Fast.lowFilter_density2",5);
    
//    private boolean showCorrectionMatrix = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.showCorrectionMatrix",false);
//    private boolean showCorrectionGradient = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.showCorrectionGradient",false);
    
//    private boolean showRight = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.showRight",false);
    
//    private boolean showPalm = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.showPalm",false);
    
//    private boolean showSkeletton = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.showSkeletton",false);
//    private boolean showSecondFilter = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.showSecondFilter",false);
//    private boolean showTopography = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.showTopography",false);
    
    
//    private boolean restart=getPrefs().getBoolean("PawTrackerStereoBoard3Fast.restart",false);
    
    private boolean resetPawTracking=getPrefs().getBoolean("PawTrackerStereoBoard3Fast.resetPawTracking",false);
    private boolean resetClusters=getPrefs().getBoolean("PawTrackerStereoBoard3Fast.resetClusters",false);
  
    
    
//    private boolean validateParameters=getPrefs().getBoolean("PawTrackerStereoBoard3Fast.validateParameters",false);
    
    private float event_strength=getPrefs().getFloat("PawTrackerStereoBoard3Fast.event_strength",2f);
    
    private float decayTimeLimit=getPrefs().getFloat("PawTrackerStereoBoard3Fast.decayTimeLimit",10000);
    {setPropertyTooltip("decayTimeLimit","[microsec (us)] for decaying accumulated events");}
    private boolean decayOn = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.decayOn",false);
    {setPropertyTooltip("decayOn","switch on/off decaying accumulated image");}
    
    
 //   private boolean notCrossing = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.notCrossing",false);
    
    
    private float finger_mix=getPrefs().getFloat("PawTrackerStereoBoard3Fast.finger_mix",0.5f);
    private int finger_surround=getPrefs().getInt("PawTrackerStereoBoard3Fast.finger_surround",10);
    
    private boolean useGroups = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.useGroups",true);
    
  //  private boolean goThroughMode = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.goThroughMode",false);
//    private boolean useCorrections = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.useCorrections",true);
    private int tracker_lifeTime=getPrefs().getInt("PawTrackerStereoBoard3Fast.tracker_lifeTime",10000);
    private int tracker_prelifeTime=getPrefs().getInt("PawTrackerStereoBoard3Fast.tracker_prelifeTime",1000);
    private int tracker_viable_nb_events=getPrefs().getInt("PawTrackerStereoBoard3Fast.tracker_viable_nb_events",100);
   
       
    private float expansion_mix=getPrefs().getFloat("PawTrackerStereoBoard3Fast.expansion_mix",0.5f);
    private float trackerSubsamplingDistance=getPrefs().getFloat("PawTrackerStereoBoard3Fast.trackerSubsamplingDistance",10);//cm?
    private boolean recordTrackerData = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.recordTrackerData",false);
    private boolean logDataEnabled = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.logDataEnabled",false);
 
    
 //   private float plane_tracker_mix=getPrefs().getFloat("PawTrackerStereoBoard3Fast.plane_tracker_mix",0.5f);
 //   private boolean trackZPlane = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.trackZPlane",false);
 
    private boolean detectGrasp = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.detectGrasp",false);
    private boolean checkNose = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.checkNose",false);
 
    private int start_min_events=getPrefs().getInt("PawTrackerStereoBoard3Fast.start_min_events",10000);
    private int start_z_displacement=getPrefs().getInt("PawTrackerStereoBoard3Fast.start_z_displacement",100);
    private int grasp_timelength_min=getPrefs().getInt("PawTrackerStereoBoard3Fast.grasp_timelength_min",200000);
 
    // epipolar
  //  private boolean correctEpipolar = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.correctEpipolar",true);
    private int recordUpTo=0; //getPrefs().getInt("PawTrackerStereoBoard3Fast.recordUpTo",0);
 
    private boolean autoRecord = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.autoRecord",false);


    private float event3DLifeTime=getPrefs().getFloat("PawTrackerStereoBoard3Fast.event3DLifeTime",100);
    {setPropertyTooltip("event3DLifeTime","life time of event for 3D display, in ms");}


    private int max3DEvents=getPrefs().getInt("PawTrackerStereoBoard3Fast.max3DEvents",10000);

//    private boolean throwAwayEvents = getPrefs().getBoolean("PawTrackerStereoBoard3Fast.throwAwayEvents",false);
...
//    protected FingerCluster[] fingers = new FingerCluster[MAX_NB_FINGERS];
    ...
    public PawTrackerStereoBoard3Fast(AEChip chip) {
        super(chip);
        this.chip=chip;
    ...
    private void resetPawTracker(){
     ...
     //   System.out.println("reset PawTrackerStereoBoard3Fast reset");
                    ...
                    try {
                      ...
                      **/
                            ...
                            // display
                              ...
                              shadowCube(gl, x, y, z, cube_size, f+b, f+b, f+b, alpha, shadowFactor);
...
//    void drawGLCluster(int x1, int y1, int x2, int y2)
    ...
    public synchronized void setLogDataEnabled(boolean logDataEnabled) {
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.logDataEnabled",logDataEnabled);
    ...
    public void setDecayTimeLimit(float decayTimeLimit) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard3Fast.decayTimeLimit",decayTimeLimit);
    }
    ...
    public void setIntensityZoom(int intensityZoom) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard3Fast.intensityZoom",intensityZoom);
    }
    ...
    public void setEvent_strength(float event_strength) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard3Fast.event_strength",event_strength);
    }
    ...
    public void setResetPawTracking(boolean resetPawTracking) {
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.resetPawTracking",resetPawTracking);
    ...
    public void setResetClusters(boolean resetClusters) {
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.resetClusters",resetClusters);
...
//
//        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.restart",restart);
//
//    }
...
//        
//        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.validateParameters",validateParameters);
//        
//    }
...
//
//        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.showCorrectionGradient",showCorrectionGradient);
//    }
...
//
//        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.showCorrectionMatrix",showCorrectionMatrix);
//    }
...
//        
//        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.showSecondFilter",showSecondFilter);
//    }
...
//    
    ...
    public void setScaleAcc(boolean scaleAcc){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.scaleAcc",scaleAcc);
    }
...
//
//
//        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.showAcc",showAcc);
//    }
...
//    }
    ...
    public void setShowOnlyAcc(boolean showOnlyAcc){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.showOnlyAcc",showOnlyAcc);
    }
...
//
//        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.showDecay",showDecay);
//    }
...
//
//        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.useFilter",useFilter);
//    }
...
//    }
    ...
    public void setDecayOn(boolean decayOn){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.decayOn",decayOn);
    }
...
//        
//        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.showFrame",showFrame);
//    }
...
//    }
    ...
    public void setShowCage(boolean showCage){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.showCage",showCage);
    }
    ...
    public void setShowRetina(boolean showRetina){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.showRetina",showRetina);
    }
...
//
//        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.show2DWindow",show2DWindow);
//    }
...
//    }
      public void setShow3DWindow(boolean show3DWindow){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.show3DWindow",show3DWindow);
    }
...
//
//        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.showPlayer",showPlayer);
//    }
...
//        
//        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.showScore",showScore);
//    }
...
//
//        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.showRight",showRight);
//    }
...
//
    ...
    public void setShowFingers(boolean showFingers){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.showFingers",showFingers);
    }
    public boolean isShowFingers(){
     ...
     public void setShowFingersRange(boolean showFingersRange){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.showFingersRange",showFingersRange);
    }
...
//        
//        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.showFingerTips",showFingerTips);
//    }
...
//    }
    ...
    public void setShowZones(boolean showZones){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.showZones",showZones);
    }
...
//
//        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.showAll",showAll);
//    }
...
//
//        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.useFastMatching",useFastMatching);
//    }
...
//    }
    ...
    public void setShowRLColors(boolean showRLColors){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.showRLColors",showRLColors);
    }
    ...
    public void setShowAxes(boolean showAxes){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.showAxes",showAxes);
    }
    ...
    public void setLowFilter_radius(int lowFilter_radius) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard3Fast.lowFilter_radius",lowFilter_radius);
    }
    ...
    public void setLowFilter_density(int lowFilter_density) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard3Fast.lowFilter_density",lowFilter_density);
    }
    ...
    public void setLowFilter_threshold(float lowFilter_threshold) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard3Fast.lowFilter_threshold",lowFilter_threshold);
    }
//    
...
//        
//        getPrefs().putInt("PawTrackerStereoBoard3Fast.lowFilter_radius2",lowFilter_radius2);
//    }
//    
...
//        
//        getPrefs().putInt("PawTrackerStereoBoard3Fast.lowFilter_density2",lowFilter_density2);
//    }
    ...
    public void setBrightness(float brightness) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard3Fast.brightness",brightness);
    }
...
//        
//        getPrefs().putFloat("PawTrackerStereoBoard3Fast.planeAngle",planeAngle);
//    }
...
//        
//        getPrefs().putFloat("PawTrackerStereoBoard3Fast.platformAngle",platformAngle);
//    }
...
//        this.alpha = alpha;
//
//        getPrefs().putFloat("PawTrackerStereoBoard3Fast.alpha",alpha);
//    }
...
//    }
    public void setIntensity(float intensity) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard3Fast.intensity",intensity);
    }
...
//        
//        getPrefs().putInt("PawTrackerStereoBoard3Fast.dispAvgRange",dispAvgRange);
//    }
...
//    }
    ...
    public void setValueThreshold(float valueThreshold) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard3Fast.valueThreshold",valueThreshold);
    }
...
//
//        getPrefs().putFloat("PawTrackerStereoBoard3Fast.accValueThreshold",accValueThreshold);
//    }
...
//    }
    ...
    public void setGrasp_max_elevation(int grasp_max_elevation) {
        ...
        compute3DParameters();
        getPrefs().putInt("PawTrackerStereoBoard3Fast.grasp_max_elevation",grasp_max_elevation);
    }
    ...
    public void setMax_finger_clusters(int max_finger_clusters) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard3Fast.max_finger_clusters",max_finger_clusters);
    }
    ...
    public void setCage_distance(float cage_distance) {
        ...
        compute3DParameters();
        getPrefs().putFloat("PawTrackerStereoBoard3Fast.cage_distance",cage_distance);
    }
    ...
    public void setRetina_tilt_angle(float retina_tilt_angle) {
        ...
        compute3DParameters();
        getPrefs().putFloat("PawTrackerStereoBoard3Fast.retina_tilt_angle",retina_tilt_angle);
    }
    
    public void setRetina_height(float retina_height) {
        this.retina_height = retina_height;
        compute3DParameters();
        getPrefs().putFloat("PawTrackerStereoBoard3Fast.retina_height",retina_height);
    }
    ...
    public void setCage_base_height(float cage_base_height) {
        ...
        compute3DParameters();
        getPrefs().putFloat("PawTrackerStereoBoard3Fast.cage_base_height",cage_base_height);
    }
    public float getCage_base_height() {
     ...
     public void setCage_door_offset(float cage_door_offset) {
        ...
        compute3DParameters();
        getPrefs().putFloat("PawTrackerStereoBoard3Fast.cage_door_offset",cage_door_offset);
    }
    ...
    public void setCage_door_height(float cage_door_height) {
        ...
        compute3DParameters();
        getPrefs().putFloat("PawTrackerStereoBoard3Fast.cage_door_height",cage_door_height);
    }
    ...
    public void setCage_height(float cage_height) {
        ...
        compute3DParameters();
        getPrefs().putFloat("PawTrackerStereoBoard3Fast.cage_height",cage_height);
    }
    ...
    public void setCage_width(float cage_width) {
        ...
        compute3DParameters();
        getPrefs().putFloat("PawTrackerStereoBoard3Fast.cage_width",cage_width);
    }
    ...
    public void setCage_platform_length(float cage_platform_length) {
        ...
        compute3DParameters();
        getPrefs().putFloat("PawTrackerStereoBoard3Fast.cage_platform_length",cage_platform_length);
    }
    ...
    public void setCage_door_width(float cage_door_width) {
        ...
        compute3DParameters();
        getPrefs().putFloat("PawTrackerStereoBoard3Fast.cage_door_width",cage_door_width);
    }
...
//
//        getPrefs().putInt("PawTrackerStereoBoard3Fast.yLeftCorrection",yLeftCorrection);
//    }
...
//
//        getPrefs().putInt("PawTrackerStereoBoard3Fast.yRightCorrection",yRightCorrection);
//    }
...
//
//        getPrefs().putFloat("PawTrackerStereoBoard3Fast.yCurveFactor",yCurveFactor);
//    }
...
//
//        getPrefs().putFloat("PawTrackerStereoBoard3Fast.colorizeFactor",colorizeFactor);
//    }
...
//
//        getPrefs().putFloat("PawTrackerStereoBoard3Fast.shadowFactor",shadowFactor);
//    }
...
//
//        getPrefs().putInt("PawTrackerStereoBoard3Fast.zFactor",zFactor);
//    }
...
//
//        getPrefs().putFloat("PawTrackerStereoBoard3Fast.valueMargin",valueMargin);
//    }
...
//
//        getPrefs().putFloat("PawTrackerStereoBoard3Fast.correctLeftAngle",correctLeftAngle);
//    }
...
//
//        getPrefs().putFloat("PawTrackerStereoBoard3Fast.correctRightAngle",correctRightAngle);
//    }
...
//
//        getPrefs().putInt("PawTrackerStereoBoard3Fast.colorizePeriod",colorizePeriod);
//    }
...
//
//        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.highlightDecay",highlightDecay);
//    }
...
//
//        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.showZColor",showZColor);
//    }
...
//
//        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.showYColor",showYColor);
//    }
...
//
//        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.showXColor",showXColor);
//    }
...
//
    ...
    public void setTrackFingers(boolean trackFingers){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.trackFingers",trackFingers);
    }
...
//        
//        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.showShadows",showShadows);
//    }
...
//        
//        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.showCorner",showCorner);
//    }
...
//
//        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.correctY",correctY);
//    }
...
//
    public void setCube_size(int cube_size) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard3Fast.cube_size",cube_size);
    }
...
//        
//        getPrefs().putInt("PawTrackerStereoBoard3Fast.disparity_range",disparity_range);
//    }
...
//
//        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.notCrossing",notCrossing);
//    }
...
//    }
    ...
    public void setFinger_mix(float finger_mix) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard3Fast.finger_mix",finger_mix);
    }
    ...
    public void setExpansion_mix(float expansion_mix) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard3Fast.expansion_mix",expansion_mix);
    }
...
//        getPrefs().putFloat("PawTrackerStereoBoard3Fast.plane_tracker_mix",plane_tracker_mix);
//    }
    ...
    public void setTrackerSubsamplingDistance(float trackerSubsamplingDistance) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard3Fast.trackerSubsamplingDistance",trackerSubsamplingDistance);
    }
    ...
    public void setFinger_surround(int finger_surround) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard3Fast.finger_surround",finger_surround);
    }
    ...
    public void setTracker_lifeTime(int tracker_lifeTime) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard3Fast.tracker_lifeTime",tracker_lifeTime);
    }
    ...
    public void setTracker_prelifeTime(int tracker_prelifeTime) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard3Fast.tracker_prelifeTime",tracker_prelifeTime);
    }
    ...
    public void setTracker_viable_nb_events(int tracker_viable_nb_events) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard3Fast.tracker_viable_nb_events",tracker_viable_nb_events);
    }
    ...
    public void setUseGroups(boolean useGroups){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.useGroups",useGroups);
    }
...
//        
//        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.goThroughMode",goThroughMode);
//    }
...
//
//        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.useCorrections",useCorrections);
//    }
...
//        getPrefs().putFloat("PawTrackerStereoBoard3Fast.focal_length",focal_length);
//        compute3DParameters();
//    }
//
...
//        getPrefs().putFloat("PawTrackerStereoBoard3Fast.retinae_distance",retinae_distance);
//        compute3DParameters();
//    }
...
//        getPrefs().putFloat("PawTrackerStereoBoard3Fast.pixel_size",pixel_size);
//        compute3DParameters();
//    }
...
//        getPrefs().putFloat("PawTrackerStereoBoard3Fast.retina_angle",retina_angle);
//        compute3DParameters();
//    }
...
//    }
    ...
    public void setRecordTrackerData(boolean recordTrackerData){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.recordTrackerData",recordTrackerData);
    }
...
//        
//        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.trackZPlane",trackZPlane);
//    }
...
//    }
    ...
    public void setDetectGrasp(boolean detectGrasp){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.detectGrasp",detectGrasp);
    }
    ...
    public void setCheckNose(boolean checkNose){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.checkNose",checkNose);
    }
   ...
   public void setMax3DEvents(int max3DEvents) {
        ...
        compute3DParameters();
        getPrefs().putInt("PawTrackerStereoBoard3Fast.max3DEvents",max3DEvents);
    }
    ...
    public void setStart_z_displacement(int start_z_displacement) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard3Fast.start_z_displacement",start_z_displacement);
    }
    ...
    public void setStart_min_events(int start_min_events) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard3Fast.start_min_events",start_min_events);
    }
    ...
    public void setGrasp_timelength_min(int grasp_timelength_min) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard3Fast.grasp_timelength_min",grasp_timelength_min);
    }
    ...
    public void setRecordUpTo(int recordUpTo) {
       ...
       // getPrefs().putInt("PawTrackerStereoBoard3Fast.recordUpTo",recordUpTo);
    }
    ...
    public void setAutoRecord(boolean autoRecord){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.autoRecord",autoRecord);
    }
    ...
    public void setEvent3DLifeTime(float event3DLifeTime) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard3Fast.event3DLifeTime",event3DLifeTime);
...
//        
//        getPrefs().putBoolean("PawTrackerStereoBoard3Fast.throwAwayEvents",throwAwayEvents);
//    }
    ...
    public void setzoom3D(int zoom3D) {
        this.zoom3D = zoom3D;
        compute3DParameters();
       getPrefs().putInt("PawTrackerStereoBoard3Fast.zoom3D",zoom3D);
    }
