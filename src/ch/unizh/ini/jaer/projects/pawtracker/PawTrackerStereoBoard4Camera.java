/*
 * PawTrackerStereoBoard4Camera.java
 ...
 *
 * Paul Rogister, Created on June, 2009
 *
 * added camera
 * added increased weight for events if in front of tracker, for tracker movement
 * added tilt of camera instaed of tilt of cage
 * corrected value change before parameters computed error
 * still need to use calibrated camera position
 * problem with image reversion in cameras : corrected with gluscalef but now pb with rotating center
 * added grid display
 * should use same compute3Dzones as label4
 * to change in openglcamera: y rotation
 */
 ...
 * @author rogister
 */
public class PawTrackerStereoBoard4Camera extends EventFilter2D implements FrameAnnotater, Observer, AE3DPlayerInterface, AE3DRecorderInterface /*, PreferenceChangeListener*/ {
...
//                            }
  ...
  //  private float planeAngle=getPrefs().getFloat("PawTrackerStereoBoard4Camera.planeAngle",-30.0f);
 //   private float platformAngle=getPrefs().getFloat("PawTrackerStereoBoard4Camera.platformAngle",-20.0f);
    
    private float retina_tilt_angle=getPrefs().getFloat("PawTrackerStereoBoard4Camera.retina_tilt_angle",-40.0f);
    {setPropertyTooltip("retina_tilt_angle","forward tilt angle of the retinae, in degrees");}
    private float retina_height=getPrefs().getFloat("PawTrackerStereoBoard4Camera.retina_height",30.0f);
    {setPropertyTooltip("retina_height","height of retina lens, in mm");}
    private float cage_distance=getPrefs().getFloat("PawTrackerStereoBoard4Camera.cage_distance",100.0f);
    {setPropertyTooltip("cage_distance","distance between stereoboard center and cage door, in mm");}
    private float cage_door_height=getPrefs().getFloat("PawTrackerStereoBoard4Camera.cage_door_height",30.0f);
    {setPropertyTooltip("cage_door_height","height of the cage door, in mm");}
    private float cage_height=getPrefs().getFloat("PawTrackerStereoBoard4Camera.cage_height",400.0f);
    {setPropertyTooltip("cage_height","height of the cage, in mm");}
    private float cage_width=getPrefs().getFloat("PawTrackerStereoBoard4Camera.cage_width",200.0f);
    {setPropertyTooltip("cage_width","width of the cage, in mm");}
    private float cage_platform_length=getPrefs().getFloat("PawTrackerStereoBoard4Camera.cage_platform_length",30.0f);
    {setPropertyTooltip("cage_platform_length","length toward retina of cage's platform, in mm");}
    private float cage_door_width=getPrefs().getFloat("PawTrackerStereoBoard4Camera.cage_door_width",10.0f);
    {setPropertyTooltip("cage_door_width","width of the cage's door, in mm");}
   
    private float cage_door_offset=getPrefs().getFloat("PawTrackerStereoBoard4Camera.cage_door_offset",0.0f);
    {setPropertyTooltip("cage_door_offset","offset of the cage's door toward left, in mm");}

    
    

    private float focal_length=getPrefs().getFloat("PawTrackerStereoBoard4Camera.focal_length",6.0f);
   {setPropertyTooltip("focal_length","focal length in mm");}
    private float retinae_distance=getPrefs().getFloat("PawTrackerStereoBoard4Camera.retinae_distance",100.0f);
   {setPropertyTooltip("retinae_distance","distance between the two retinae in mm");}
    private float pixel_size=getPrefs().getFloat("PawTrackerStereoBoard4Camera.pixel_size",0.04f);
   {setPropertyTooltip("pixel_size","pixel size of retina in mm");}
    private float retina_angle=getPrefs().getFloat("PawTrackerStereoBoard4Camera.retina_angle",10.0f);
   {setPropertyTooltip("retina_angle","angle of rotation of retina in degrees");}
  
    
    
    private int max_finger_clusters=getPrefs().getInt("PawTrackerStereoBoard4Camera.max_finger_clusters",10);
    private int grasp_max_elevation=getPrefs().getInt("PawTrackerStereoBoard4Camera.grasp_max_elevation",15);
 
    
    
    private float alpha=getPrefs().getFloat("PawTrackerStereoBoard4Camera.alpha",0.1f);
    private float intensity=getPrefs().getFloat("PawTrackerStereoBoard4Camera.intensity",1);
    
    
 //   private int dispAvgRange=getPrefs().getInt("PawTrackerStereoBoard4Camera.dispAvgRange",1);
    
    private int yLeftCorrection=getPrefs().getInt("PawTrackerStereoBoard4Camera.yLeftCorrection",0);
    private int yRightCorrection=getPrefs().getInt("PawTrackerStereoBoard4Camera.yRightCorrection",0);
    
    private float yCurveFactor=getPrefs().getFloat("PawTrackerStereoBoard4Camera.yCurveFactor",0.1f);
    
    private float valueThreshold=getPrefs().getFloat("PawTrackerStereoBoard4Camera.valueThreshold",0);
    private float accValueThreshold=getPrefs().getFloat("PawTrackerStereoBoard4Camera.accValueThreshold",0);
 
    
    private float shadowFactor=getPrefs().getFloat("PawTrackerStereoBoard4Camera.shadowFactor",0.3f);
    private float colorizeFactor=getPrefs().getFloat("PawTrackerStereoBoard4Camera.colorizeFactor",0.1f);
    private int colorizePeriod=getPrefs().getInt("PawTrackerStereoBoard4Camera.colorizePeriod",183);
    
    
    private int zFactor=getPrefs().getInt("PawTrackerStereoBoard4Camera.zFactor",1);
    private float valueMargin=getPrefs().getFloat("PawTrackerStereoBoard4Camera.valueMargin",0.3f);
    
 //   private int disparity_range=getPrefs().getInt("PawTrackerStereoBoard4Camera.disparity_range",50);
    
    private int cube_size=getPrefs().getInt("PawTrackerStereoBoard4Camera.cube_size",1);
    
   
   
    private int retinaSize=getPrefs().getInt("PawTrackerStereoBoard4Camera.retinaSize",128);
    
    private int intensityZoom = getPrefs().getInt("PawTrackerStereoBoard4Camera.intensityZoom",2);
    {setPropertyTooltip("intensityZoom","zoom for tracker window");}
    
    
    private float brightness=getPrefs().getFloat("PawTrackerStereoBoard4Camera.brightness",1f);
    {setPropertyTooltip("brightness","brightness or increase of display for accumulated values");}
    
    
    private float correctLeftAngle=getPrefs().getFloat("PawTrackerStereoBoard4Camera.correctLeftAngle",0.0f);
    private float correctRightAngle=getPrefs().getFloat("PawTrackerStereoBoard4Camera.correctRightAngle",0.0f);
    
    
    private boolean useFastMatching = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.useFastMatching",true);
    private boolean showYColor = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.showYColor",false);
    private boolean showXColor = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.showXColor",false);
    private boolean showZColor = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.showZColor",false);
 //   private boolean showShadows = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.showShadows",false);
 //   private boolean showCorner = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.showCorner",false);
    
    private boolean highlightDecay = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.highlightDecay",false);
    
    
    
    private boolean correctY = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.correctY",false);
    private boolean useFilter = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.useFilter",false);
    
 //   private boolean useLarge = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.useLarge",false);
    
    
    private boolean showFingers = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.showFingers",true);
    private boolean showFingersRange = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.showFingersRange",false);

 //   private boolean showFingerTips = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.showFingerTips",true);
    
    private boolean showZones = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.showZones",true);
    private boolean showAll = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.showAll",true);
    // show intensity inside shape
    
    private boolean showAcc = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.showAcc",false);
    private boolean showOnlyAcc = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.showOnlyAcc",false);
    private boolean showDecay = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.showDecay",false);
    
    
    private boolean scaleAcc = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.scaleAcc",true);
    
    private boolean showCage = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.showCage",true);
    private boolean showRetinaBox = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.showRetinaBox",true);
    private boolean showGrid = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.showGrid",true);


  //  private boolean showFrame = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.showFrame",true);
    private boolean show2DWindow = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.show2DWindow",true);
    private boolean show3DWindow = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.show3DWindow",true);
    private boolean showPlayer = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.showPlayer",true);
  //  private boolean showScore = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.showScore",false);
    private boolean showRetina = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.showRetina",false);
  
    private boolean trackFingers = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.trackFingers",false);
  
    
    //  private boolean showShapePoints = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.showShapePoints",true);
    //   private boolean showFingerPoints = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.showFingerPoints",true);
    
    
    
    //   private boolean showShape = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.showShape",true);
    private boolean showRLColors = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.showRLColors",false);
    private boolean showAxes = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.showAxes",true);
    
    
    private int lowFilter_radius=getPrefs().getInt("PawTrackerStereoBoard4Camera.lowFilter_radius",3);
    private int lowFilter_density=getPrefs().getInt("PawTrackerStereoBoard4Camera.lowFilter_density",17);
    private float lowFilter_threshold=getPrefs().getFloat("PawTrackerStereoBoard4Camera.lowFilter_threshold",0);
    
  //  private int lowFilter_radius2=getPrefs().getInt("PawTrackerStereoBoard4Camera.lowFilter_radius2",10);
 //   private int lowFilter_density2=getPrefs().getInt("PawTrackerStereoBoard4Camera.lowFilter_density2",5);
    
    private boolean showCorrectionMatrix = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.showCorrectionMatrix",false);
    private boolean showCorrectionGradient = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.showCorrectionGradient",false);
    
    private boolean showRight = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.showRight",false);
    
//    private boolean showPalm = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.showPalm",false);
    
//    private boolean showSkeletton = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.showSkeletton",false);
//    private boolean showSecondFilter = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.showSecondFilter",false);
//    private boolean showTopography = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.showTopography",false);
    
    
    private boolean restart=getPrefs().getBoolean("PawTrackerStereoBoard4Camera.restart",false);
    
    private boolean resetPawTracking=getPrefs().getBoolean("PawTrackerStereoBoard4Camera.resetPawTracking",false);
    private boolean resetClusters=getPrefs().getBoolean("PawTrackerStereoBoard4Camera.resetClusters",false);
  
    
    
//    private boolean validateParameters=getPrefs().getBoolean("PawTrackerStereoBoard4Camera.validateParameters",false);
    
    private float event_strength=getPrefs().getFloat("PawTrackerStereoBoard4Camera.event_strength",2f);
    
    private float decayTimeLimit=getPrefs().getFloat("PawTrackerStereoBoard4Camera.decayTimeLimit",10000);
    {setPropertyTooltip("decayTimeLimit","[microsec (us)] for decaying accumulated events");}
    private boolean decayOn = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.decayOn",false);
    {setPropertyTooltip("decayOn","switch on/off decaying accumulated image");}
    
    
    private boolean notCrossing = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.notCrossing",false);
    
    
    private float finger_mix=getPrefs().getFloat("PawTrackerStereoBoard4Camera.finger_mix",0.5f);
    private int finger_surround=getPrefs().getInt("PawTrackerStereoBoard4Camera.finger_surround",10);
    
    private boolean useGroups = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.useGroups",false);
    
    private boolean goThroughMode = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.goThroughMode",false);
    private boolean useCorrections = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.useCorrections",true);
    private int tracker_lifeTime=getPrefs().getInt("PawTrackerStereoBoard4Camera.tracker_lifeTime",10000);
    private int tracker_prelifeTime=getPrefs().getInt("PawTrackerStereoBoard4Camera.tracker_prelifeTime",1000);
    private int tracker_viable_nb_events=getPrefs().getInt("PawTrackerStereoBoard4Camera.tracker_viable_nb_events",100);
   
       
    private float expansion_mix=getPrefs().getFloat("PawTrackerStereoBoard4Camera.expansion_mix",0.5f);
    private float trackerSubsamplingDistance=getPrefs().getFloat("PawTrackerStereoBoard4Camera.trackerSubsamplingDistance",10);//cm?
    private boolean recordTrackerData = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.recordTrackerData",false);
    private boolean logDataEnabled = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.logDataEnabled",false);
 
    
    private float plane_tracker_mix=getPrefs().getFloat("PawTrackerStereoBoard4Camera.plane_tracker_mix",0.5f);
    private boolean trackZPlane = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.trackZPlane",false);
 
    private boolean detectGrasp = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.detectGrasp",false);
    private boolean checkNose = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.checkNose",false);
 
    private int start_min_events=getPrefs().getInt("PawTrackerStereoBoard4Camera.start_min_events",10000);
    private int start_z_displacement=getPrefs().getInt("PawTrackerStereoBoard4Camera.start_z_displacement",100);
    private int grasp_timelength_min=getPrefs().getInt("PawTrackerStereoBoard4Camera.grasp_timelength_min",200000);
 
    // epipolar
    private boolean correctEpipolar = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.correctEpipolar",true);
    private int recordUpTo=0; //getPrefs().getInt("PawTrackerStereoBoard4Camera.recordUpTo",0);
 
       
//    private boolean throwAwayEvents = getPrefs().getBoolean("PawTrackerStereoBoard4Camera.throwAwayEvents",false);
 
     private float y_rotation_dist=getPrefs().getFloat("PawTrackerStereoBoard4Camera.y_rotation_dist",10000);
...
//            
           // float exp_mix = expansion_mix;// /100;
            float dmix = ((z-this.z)/finger_surround)*0.2f;
            mix += dmix;
            if(mix>1) mix=1;
            if(mix<0) mix = 0;
     ...
     //   int time = 0;
      ...
      //  boolean activated = false;
       ...
       //     this.time = time;
        ...
        public void add( float x, float y, float z, float mix){
...
//    protected FingerCluster[] fingers = new FingerCluster[MAX_NB_FINGERS];
    ...
    public PawTrackerStereoBoard4Camera(AEChip chip) {
        super(chip);
        this.chip=chip;
    ...
    private void resetPawTracker(){
        ...
        System.out.println("reset PawTrackerStereoBoard4Camera reset");
...
//        }
    ...
    private synchronized void compute3DParameters(){
        ...
        // replace both  by stereopair.updateRealCoordinates(rd,ld=0,retina_angle)
         for (int i=0; i<leftPoints.length; i++){
            for (int j=0; j<leftPoints[i].length; j++){
                ...
                leftPoints[i][j].xr = (i-halfRetinaSize);
                leftPoints[i][j].yr = (j-halfRetinaSize);
                leftPoints[i][j].zr = Math.round(fc_left_dist);
                // rotate with world angle
                lp.x = leftPoints[i][j].xr;
                lp.y = leftPoints[i][j].yr;
                lp.z = leftPoints[i][j].zr;
                lp = lp.rotateOnX(  0,  0,  -retina_tilt_angle);
                leftPoints[i][j].xr = Math.round(lp.x);
                leftPoints[i][j].yr = Math.round(lp.y);
                leftPoints[i][j].zr = Math.round(lp.z);
     ...
     //  right_focal = new Point(-retina_translation[0],-retina_translation[1],-retina_translation[2]);
       ...
       Point rp = new Point();
        ...
        right_focal.z = rp.z;
         ...
         for (int i=0; i<rightPoints.length; i++){
            for (int j=0; j<rightPoints[i].length; j++){
                ...
                rightPoints[i][j].xr = Math.round(i-halfRetinaSize-retina_translation[0]);
                rightPoints[i][j].yr = Math.round(j-halfRetinaSize-retina_translation[1]);
                rightPoints[i][j].zr = Math.round(fc_right_dist-retina_translation[2]);
             ...
             //   if(i==0&&j==0)System.out.println("\n 1. rightRetinaCoordinates "+rightRetinaCoordinates[i][j].x+" "+rightRetinaCoordinates[i][j].y+" "+rightRetinaCoordinates[i][j].z);
                ...
                rp.x = rightPoints[i][j].xr;
                rp.y = rightPoints[i][j].yr;
                rp.z = rightPoints[i][j].zr;
                rp.rotate(retina_rotation);
                rp = rp.rotateOnX(  0,  0,  -retina_tilt_angle);
                rightPoints[i][j].xr = Math.round(rp.x);
                rightPoints[i][j].yr = Math.round(rp.y);
                rightPoints[i][j].zr = Math.round(rp.z);
        ...
        searchSpace.p1 = new Point(x_mid-Math.round(cage_width*scaleFactor/2)-door_offset,Math.round(cage_door_height*scaleFactor-base_height)+1,z2);
        searchSpace.p2 = new Point(x_mid+Math.round(cage_width*scaleFactor/2)-door_offset,Math.round(cage_door_height*scaleFactor-base_height)+1,z2);
        searchSpace.p3 = new Point(x_mid-Math.round(cage_width*scaleFactor/2)-door_offset,Math.round((grasp_max_elevation+cage_door_height)*scaleFactor-base_height),z2);
        searchSpace.p4 = new Point(x_mid+Math.round(cage_width*scaleFactor/2)-door_offset,Math.round((grasp_max_elevation+cage_door_height)*scaleFactor-base_height),z2);
        searchSpace.p5 = new Point(x_mid-Math.round(cage_width*scaleFactor/2)-door_offset,Math.round(cage_door_height*scaleFactor-base_height)+1,z3);
        searchSpace.p6 = new Point(x_mid+Math.round(cage_width*scaleFactor/2)-door_offset,Math.round(cage_door_height*scaleFactor-base_height)+1,z3);
        searchSpace.p7 = new Point(x_mid-Math.round(cage_width*scaleFactor/2)-door_offset,Math.round((grasp_max_elevation+cage_door_height)*scaleFactor-base_height),z3);
        searchSpace.p8 = new Point(x_mid+Math.round(cage_width*scaleFactor/2)-door_offset,Math.round((grasp_max_elevation+cage_door_height)*scaleFactor-base_height),z3);
   ...
   //     searchSpace.tilt(retina_tilt_angle);
    ...
    //    endSpace.tilt(retina_tilt_angle);
        ...
        noseSpace.p1 = new Point(x_mid-Math.round(cage_door_width*scaleFactor/2)-door_offset,Math.round((cage_door_height+10)*scaleFactor-base_height)+1,z4);
        noseSpace.p2 = new Point(x_mid+Math.round(cage_door_width*scaleFactor/2)-door_offset,Math.round((cage_door_height+10)*scaleFactor-base_height)+1,z4);
        noseSpace.p3 = new Point(x_mid-Math.round(cage_door_width*scaleFactor/2)-door_offset,Math.round((grasp_max_elevation+cage_door_height+5)*scaleFactor-base_height),z4);
        noseSpace.p4 = new Point(x_mid+Math.round(cage_door_width*scaleFactor/2)-door_offset,Math.round((grasp_max_elevation+cage_door_height+5)*scaleFactor-base_height),z4);
        noseSpace.p5 = new Point(x_mid-Math.round(cage_door_width*scaleFactor/2)-door_offset,Math.round((cage_door_height+10)*scaleFactor-base_height)+1,z3);
        noseSpace.p6 = new Point(x_mid+Math.round(cage_door_width*scaleFactor/2)-door_offset,Math.round((cage_door_height+10)*scaleFactor-base_height)+1,z3);
        noseSpace.p7 = new Point(x_mid-Math.round(cage_door_width*scaleFactor/2)-door_offset,Math.round((grasp_max_elevation+cage_door_height+5)*scaleFactor-base_height),z3);
        noseSpace.p8 = new Point(x_mid+Math.round(cage_door_width*scaleFactor/2)-door_offset,Math.round((grasp_max_elevation+cage_door_height+5)*scaleFactor-base_height),z3);
...
//                        
    ...
    protected void processEvent(BinocularEvent e){
       ...
       int type=e.polarity==BinocularEvent.Polarity.Off? 0: 1;
        ...
        int dy = e.y;// = (retinaSize-1)-e.y;
        int dx = e.x;// = (retinaSize-1)-e.x;
    ...
    private synchronized float xUnRotated(float x, float y, float z){
        return x;
        
    }
    private synchronized float yUnRotated(float x, float y, float z){
         float y_rx = rotateYonX( y, z, 0, 0, -retina_tilt_angle);
         return y_rx;
        
    }
    private synchronized float zUnRotated(float x, float y, float z){
         float z_rx = rotateZonX( y, z, 0, 0, -retina_tilt_angle);
         return z_rx;
    }

    
    private synchronized boolean isInSearchSpace( Zone zone, float x, float y, float z){
        boolean res = true;
        
        // Paul: to modify since we are now in real 3D, no need for rotation
        
        float y_rx = y; //rotateYonX( y, z, 0, 0, -retina_tilt_angle);
        float z_rx = z; //rotateZonX( y, z, 0, 0, -retina_tilt_angle);
    ...
    protected float distanceBetween( float x1, float y1, float z1, float x2, float y2, float z2){
                    ...
                    try {
                      ...
                      **/
                            ...
                            if(clearSpaceMode){
                                if(isInSearchSpace(searchSpace,x,y,z)){
                                    if(searchSpaceMode){
                                        int xsp = Math.round(xUnRotated(x,y,z));
                                        int ysp = Math.round(yUnRotated(x,y,z));
                                        int zsp = Math.round(zUnRotated(x,y,z));
                                    ...
                                    try {
                                        ...
                                        if(clearSpaceMode){
                                            if(isInSearchSpace(searchSpace,x0,y1,z0)){
                                                if(searchSpaceMode){
                                                    float x0sp = xUnRotated(x0,y1,z0);
                                                    float ysp = yUnRotated(x0,y1,z0);
                                                    float z0sp = zUnRotated(x0,y1,z0);
            ...
            private void draw3DFrames( GL gl ){
               // int half = retinaSize/2;
                ...
                if(showGrid){
                     ...
                     //x
                     for (int xi=-2500;xi<2501;xi+=250){
                         line3D( gl,  xi, 0,  -2500,  xi, 0, 2500);
                     ...
                     // z
                      for (int zi=-2500;zi<2501;zi+=250){
                         line3D( gl, -2500, 0, zi, 2500, 0, zi);
                ...
                if(showCage){
                  ...
                  if(showZones){
                    gl.glColor3f(1.0f,1.0f,0.0f);	// yellow color
                        ...
                        line3D( gl,  searchSpace.p1.x,  searchSpace.p1.y,  searchSpace.p1.z,   searchSpace.p2.x,  searchSpace.p2.y,  searchSpace.p2.z);                        
                        line3D( gl,  searchSpace.p1.x,  searchSpace.p1.y,  searchSpace.p1.z,  searchSpace.p3.x,  searchSpace.p3.y,  searchSpace.p3.z);
                        line3D( gl,  searchSpace.p2.x,  searchSpace.p2.y,  searchSpace.p2.z,  searchSpace.p4.x,  searchSpace.p4.y,  searchSpace.p4.z);                        
                        line3D( gl,  searchSpace.p3.x,  searchSpace.p3.y,  searchSpace.p3.z,  searchSpace.p4.x,  searchSpace.p4.y,  searchSpace.p4.z);    
                        line3D( gl,  searchSpace.p5.x,  searchSpace.p5.y,  searchSpace.p5.z,  searchSpace.p6.x,  searchSpace.p6.y,  searchSpace.p6.z);
                        line3D( gl,  searchSpace.p5.x,  searchSpace.p5.y,  searchSpace.p5.z,  searchSpace.p7.x,  searchSpace.p7.y,  searchSpace.p7.z);
                        line3D( gl,  searchSpace.p6.x,  searchSpace.p6.y,  searchSpace.p6.z,  searchSpace.p8.x,  searchSpace.p8.y,  searchSpace.p8.z); 
                        
                        line3D( gl,  searchSpace.p7.x,  searchSpace.p7.y,  searchSpace.p7.z,  searchSpace.p8.x,  searchSpace.p8.y,  searchSpace.p8.z);             
                        line3D( gl,  searchSpace.p1.x,  searchSpace.p1.y,  searchSpace.p1.z,  searchSpace.p5.x,  searchSpace.p5.y,  searchSpace.p5.z);
                        line3D( gl,  searchSpace.p2.x,  searchSpace.p2.y,  searchSpace.p2.z,  searchSpace.p6.x,  searchSpace.p6.y,  searchSpace.p6.z);       
                        line3D( gl,  searchSpace.p3.x,  searchSpace.p3.y,  searchSpace.p3.z,  searchSpace.p7.x,  searchSpace.p7.y,  searchSpace.p7.z);       
                        line3D( gl,  searchSpace.p4.x,  searchSpace.p4.y,  searchSpace.p4.z,  searchSpace.p8.x,  searchSpace.p8.y,  searchSpace.p8.z);       
...
//                        
                        ...
                        line3D( gl,  noseSpace.p1.x,  noseSpace.p1.y,  noseSpace.p1.z,   noseSpace.p2.x,  noseSpace.p2.y,  noseSpace.p2.z);
                        line3D( gl,  noseSpace.p1.x,  noseSpace.p1.y,  noseSpace.p1.z,  noseSpace.p3.x,  noseSpace.p3.y,  noseSpace.p3.z);
                        line3D( gl,  noseSpace.p2.x,  noseSpace.p2.y,  noseSpace.p2.z,  noseSpace.p4.x,  noseSpace.p4.y,  noseSpace.p4.z);
                        line3D( gl,  noseSpace.p3.x,  noseSpace.p3.y,  noseSpace.p3.z,  noseSpace.p4.x,  noseSpace.p4.y,  noseSpace.p4.z);
                        line3D( gl,  noseSpace.p5.x,  noseSpace.p5.y,  noseSpace.p5.z,  noseSpace.p6.x,  noseSpace.p6.y,  noseSpace.p6.z);
                        line3D( gl,  noseSpace.p5.x,  noseSpace.p5.y,  noseSpace.p5.z,  noseSpace.p7.x,  noseSpace.p7.y,  noseSpace.p7.z);
                        line3D( gl,  noseSpace.p6.x,  noseSpace.p6.y,  noseSpace.p6.z,  noseSpace.p8.x,  noseSpace.p8.y,  noseSpace.p8.z);
                        
                        line3D( gl,  noseSpace.p7.x,  noseSpace.p7.y,  noseSpace.p7.z,  noseSpace.p8.x,  noseSpace.p8.y,  noseSpace.p8.z);
                        line3D( gl,  noseSpace.p1.x,  noseSpace.p1.y,  noseSpace.p1.z,  noseSpace.p5.x,  noseSpace.p5.y,  noseSpace.p5.z);
                        line3D( gl,  noseSpace.p2.x,  noseSpace.p2.y,  noseSpace.p2.z,  noseSpace.p6.x,  noseSpace.p6.y,  noseSpace.p6.z);
                        line3D( gl,  noseSpace.p3.x,  noseSpace.p3.y,  noseSpace.p3.z,  noseSpace.p7.x,  noseSpace.p7.y,  noseSpace.p7.z);
                        line3D( gl,  noseSpace.p4.x,  noseSpace.p4.y,  noseSpace.p4.z,  noseSpace.p8.x,  noseSpace.p8.y,  noseSpace.p8.z);
             ...
             //   }
               ...
               ///     Color trackerColor = null;
                 ...
                 if(trackZPlane){
                    ...
                    float x_mid = retinae_distance*scaleFactor/2;
                    
                    float base_height = (cage_door_height-retina_height)*scaleFactor + retinaSize/2;
      
                    
                    float y1 = base_height;
                    float y2 = base_height+1000;
                    float z1 = planeTracker.z;
                    
                    float y1_rx = rotateYonX( y1, z1, 0, 0, retina_tilt_angle);
                    float y2_rx = rotateYonX( y2, z1, 0, 0, retina_tilt_angle);
                    float z1_rx = rotateZonX( y1, z1, 0, 0, retina_tilt_angle);
                    float z2_rx = rotateZonX( y2, z1, 0, 0, retina_tilt_angle);
...
//    void drawGLCluster(int x1, int y1, int x2, int y2)
    ...
    public synchronized void setLogDataEnabled(boolean logDataEnabled) {
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.logDataEnabled",logDataEnabled);
    ...
    public void setDecayTimeLimit(float decayTimeLimit) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard4Camera.decayTimeLimit",decayTimeLimit);
    }
    ...
    public void setIntensityZoom(int intensityZoom) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard4Camera.intensityZoom",intensityZoom);
    }
    ...
    public void setEvent_strength(float event_strength) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard4Camera.event_strength",event_strength);
    }
    ...
    public void setResetPawTracking(boolean resetPawTracking) {
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.resetPawTracking",resetPawTracking);
    ...
    public void setResetClusters(boolean resetClusters) {
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.resetClusters",resetClusters);
    ...
    public void setRestart(boolean restart) {
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.restart",restart);
...
//        
//        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.validateParameters",validateParameters);
//        
//    }
    ...
    public void setShowCorrectionGradient(boolean showCorrectionGradient){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.showCorrectionGradient",showCorrectionGradient);
    }
    ...
    public void setShowCorrectionMatrix(boolean showCorrectionMatrix){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.showCorrectionMatrix",showCorrectionMatrix);
    }
...
//        
//        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.showSecondFilter",showSecondFilter);
//    }
...
//    
    ...
    public void setScaleAcc(boolean scaleAcc){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.scaleAcc",scaleAcc);
    }
    ...
    public void setShowAcc(boolean showAcc){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.showAcc",showAcc);
    }
    ...
    public void setShowOnlyAcc(boolean showOnlyAcc){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.showOnlyAcc",showOnlyAcc);
    }
    ...
    public void setShowDecay(boolean showDecay){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.showDecay",showDecay);
    }
    ...
    public void setUseFilter(boolean useFilter){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.useFilter",useFilter);
    }
    ...
    public void setDecayOn(boolean decayOn){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.decayOn",decayOn);
    }
...
//        
//        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.showFrame",showFrame);
//    }
...
//    }
    ...
    public void setShowGrid(boolean showGrid){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.showGrid",showGrid);
    }
    public boolean isShowGrid(){
        return showGrid;
    }

   public void setShowRetinaBox(boolean showRetinaBox){
        this.showRetinaBox = showRetinaBox;
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.showRetinaBox",showRetinaBox);
    }
    public boolean isShowRetinaBox(){
        return showRetinaBox;
    }
    public void setShowCage(boolean showCage){
        this.showCage = showCage;
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.showCage",showCage);
    }
    ...
    public void setShowRetina(boolean showRetina){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.showRetina",showRetina);
    }
    ...
    public void setShow2DWindow(boolean show2DWindow){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.show2DWindow",show2DWindow);
    }
    public boolean isShow2DWindow(){
      ...
      public void setShow3DWindow(boolean show3DWindow){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.show3DWindow",show3DWindow);
    }
    ...
    public void setShowPlayer(boolean showPlayer){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.showPlayer",showPlayer);
    }
...
//        
//        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.showScore",showScore);
//    }
...
//    
    public void setShowRight(boolean showRight){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.showRight",showRight);
    }
    ...
    public void setShowFingers(boolean showFingers){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.showFingers",showFingers);
    }
    public boolean isShowFingers(){
     ...
     public void setShowFingersRange(boolean showFingersRange){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.showFingersRange",showFingersRange);
    }
...
//        
//        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.showFingerTips",showFingerTips);
//    }
...
//    }
    ...
    public void setShowZones(boolean showZones){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.showZones",showZones);
    }
    ...
    public void setShowAll(boolean showAll){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.showAll",showAll);
    }
    ...
    public void setUseFastMatching(boolean useFastMatching){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.useFastMatching",useFastMatching);
    }
    ...
    public void setShowRLColors(boolean showRLColors){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.showRLColors",showRLColors);
    }
    ...
    public void setShowAxes(boolean showAxes){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.showAxes",showAxes);
    }
    ...
    public void setLowFilter_radius(int lowFilter_radius) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard4Camera.lowFilter_radius",lowFilter_radius);
    }
    ...
    public void setLowFilter_density(int lowFilter_density) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard4Camera.lowFilter_density",lowFilter_density);
    }
    ...
    public void setLowFilter_threshold(float lowFilter_threshold) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard4Camera.lowFilter_threshold",lowFilter_threshold);
    }
//    
...
//        
//        getPrefs().putInt("PawTrackerStereoBoard4Camera.lowFilter_radius2",lowFilter_radius2);
//    }
//    
...
//        
//        getPrefs().putInt("PawTrackerStereoBoard4Camera.lowFilter_density2",lowFilter_density2);
//    }
    ...
    public void setBrightness(float brightness) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard4Camera.brightness",brightness);
    }
...
//        
//        getPrefs().putFloat("PawTrackerStereoBoard4Camera.planeAngle",planeAngle);
//    }
...
//        
//        getPrefs().putFloat("PawTrackerStereoBoard4Camera.platformAngle",platformAngle);
//    }
    ...
    public void setAlpha(float alpha) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard4Camera.alpha",alpha);
    }
    ...
    public void setIntensity(float intensity) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard4Camera.intensity",intensity);
    }
...
//        
//        getPrefs().putInt("PawTrackerStereoBoard4Camera.dispAvgRange",dispAvgRange);
//    }
...
//    }
    ...
    public void setValueThreshold(float valueThreshold) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard4Camera.valueThreshold",valueThreshold);
    }
    ...
    public void setAccValueThreshold(float accValueThreshold) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard4Camera.accValueThreshold",accValueThreshold);
    }
    ...
    public void setGrasp_max_elevation(int grasp_max_elevation) {
        ...
        compute3DParameters();
        getPrefs().putInt("PawTrackerStereoBoard4Camera.grasp_max_elevation",grasp_max_elevation);
    }
    ...
    public void setMax_finger_clusters(int max_finger_clusters) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard4Camera.max_finger_clusters",max_finger_clusters);
    }
    ...
    public void setCage_distance(float cage_distance) {
        ...
        compute3DParameters();
        getPrefs().putFloat("PawTrackerStereoBoard4Camera.cage_distance",cage_distance);
    }
    public float getCage_distance() {
     ...
     public void setCage_door_offset(float cage_door_offset) {
        ...
        compute3DParameters();
        getPrefs().putFloat("PawTrackerStereoBoard4Camera.cage_door_offset",cage_door_offset);
    }
    ...
    public void setRetina_tilt_angle(float retina_tilt_angle) {
        ...
        compute3DParameters();
        getPrefs().putFloat("PawTrackerStereoBoard4Camera.retina_tilt_angle",retina_tilt_angle);
    }
    
    public void setRetina_height(float retina_height) {
        this.retina_height = retina_height;
        compute3DParameters();
        getPrefs().putFloat("PawTrackerStereoBoard4Camera.retina_height",retina_height);
    }
    ...
    public void setCage_door_height(float cage_door_height) {
        ...
        compute3DParameters();
        getPrefs().putFloat("PawTrackerStereoBoard4Camera.cage_door_height",cage_door_height);
    }
    ...
    public void setCage_height(float cage_height) {
        ...
        compute3DParameters();
        getPrefs().putFloat("PawTrackerStereoBoard4Camera.cage_height",cage_height);
    }
    ...
    public void setCage_width(float cage_width) {
        ...
        compute3DParameters();
        getPrefs().putFloat("PawTrackerStereoBoard4Camera.cage_width",cage_width);
    }
    ...
    public void setCage_platform_length(float cage_platform_length) {
        ...
        compute3DParameters();
        getPrefs().putFloat("PawTrackerStereoBoard4Camera.cage_platform_length",cage_platform_length);
    }
    ...
    public void setCage_door_width(float cage_door_width) {
        ...
        compute3DParameters();
        getPrefs().putFloat("PawTrackerStereoBoard4Camera.cage_door_width",cage_door_width);
    }
    ...
    public void setYLeftCorrection(int yLeftCorrection) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard4Camera.yLeftCorrection",yLeftCorrection);
    }
    ...
    public void setYRightCorrection(int yRightCorrection) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard4Camera.yRightCorrection",yRightCorrection);
    }
    ...
    public void setYCurveFactor(float yCurveFactor) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard4Camera.yCurveFactor",yCurveFactor);
    }
    ...
    public void setColorizeFactor(float colorizeFactor) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard4Camera.colorizeFactor",colorizeFactor);
    }
    ...
    public void setShadowFactor(float shadowFactor) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard4Camera.shadowFactor",shadowFactor);
    }
    ...
    public void setZFactor(int zFactor) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard4Camera.zFactor",zFactor);
    }
    ...
    public void setValueMargin(float valueMargin) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard4Camera.valueMargin",valueMargin);
    }
    ...
    public void setCorrectLeftAngle(float correctLeftAngle) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard4Camera.correctLeftAngle",correctLeftAngle);
    }
    ...
    public void setCorrectRightAngle(float correctRightAngle) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard4Camera.correctRightAngle",correctRightAngle);
    }
    ...
    public void setColorizePeriod(int colorizePeriod) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard4Camera.colorizePeriod",colorizePeriod);
    }
    ...
    public void setHighlightDecay(boolean highlightDecay){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.highlightDecay",highlightDecay);
    }
    ...
    public void setShowZColor(boolean showZColor){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.showZColor",showZColor);
    }
    ...
    public void setShowYColor(boolean showYColor){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.showYColor",showYColor);
    }
    ...
    public void setShowXColor(boolean showXColor){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.showXColor",showXColor);
    }
    ...
    public void setTrackFingers(boolean trackFingers){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.trackFingers",trackFingers);
    }
...
//        
//        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.showShadows",showShadows);
//    }
...
//        
//        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.showCorner",showCorner);
//    }
...
//    }
    ...
    public void setCorrectY(boolean correctY){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.correctY",correctY);
    }
    ...
    public void setCube_size(int cube_size) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard4Camera.cube_size",cube_size);
    }
...
//        
//        getPrefs().putInt("PawTrackerStereoBoard4Camera.disparity_range",disparity_range);
//    }
...
//    }
    ...
    public void setNotCrossing(boolean notCrossing){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.notCrossing",notCrossing);
    }
    ...
    public void setFinger_mix(float finger_mix) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard4Camera.finger_mix",finger_mix);
    }
    ...
    public void setExpansion_mix(float expansion_mix) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard4Camera.expansion_mix",expansion_mix);
    }
    ...
    public void setPlane_tracker_mix(float plane_tracker_mix) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard4Camera.plane_tracker_mix",plane_tracker_mix);
    }
    ...
    public void setTrackerSubsamplingDistance(float trackerSubsamplingDistance) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard4Camera.trackerSubsamplingDistance",trackerSubsamplingDistance);
    }
    ...
    public void setFinger_surround(int finger_surround) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard4Camera.finger_surround",finger_surround);
    }
    ...
    public void setTracker_lifeTime(int tracker_lifeTime) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard4Camera.tracker_lifeTime",tracker_lifeTime);
    }
    ...
    public void setTracker_prelifeTime(int tracker_prelifeTime) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard4Camera.tracker_prelifeTime",tracker_prelifeTime);
    }
    ...
    public void setTracker_viable_nb_events(int tracker_viable_nb_events) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard4Camera.tracker_viable_nb_events",tracker_viable_nb_events);
    }
    ...
    public void setUseGroups(boolean useGroups){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.useGroups",useGroups);
    }
    ...
    public void setGoThroughMode(boolean goThroughMode){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.goThroughMode",goThroughMode);
    }
    ...
    public void setUseCorrections(boolean useCorrections){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.useCorrections",useCorrections);
    }
    ...
    public void setFocal_length(float focal_length) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard4Camera.focal_length",focal_length);
        compute3DParameters();
    }
    ...
    public void setRetinae_distance(float retinae_distance) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard4Camera.retinae_distance",retinae_distance);
        compute3DParameters();
    }
    ...
    public void setPixel_size(float pixel_size) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard4Camera.pixel_size",pixel_size);
        compute3DParameters();
    }
    ...
    public void setRetina_angle(float retina_angle) {
        ...
        getPrefs().putFloat("PawTrackerStereoBoard4Camera.retina_angle",retina_angle);
        compute3DParameters();
    }
    ...
    public void setRecordTrackerData(boolean recordTrackerData){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.recordTrackerData",recordTrackerData);
    }
    ...
    public void setTrackZPlane(boolean trackZPlane){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.trackZPlane",trackZPlane);
    }
    ...
    public void setDetectGrasp(boolean detectGrasp){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.detectGrasp",detectGrasp);
    }
    ...
    public void setCheckNose(boolean checkNose){
        ...
        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.checkNose",checkNose);
    }
    ...
    public void setStart_z_displacement(int start_z_displacement) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard4Camera.start_z_displacement",start_z_displacement);
    }
    ...
    public void setStart_min_events(int start_min_events) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard4Camera.start_min_events",start_min_events);
    }
    ...
    public void setGrasp_timelength_min(int grasp_timelength_min) {
        ...
        getPrefs().putInt("PawTrackerStereoBoard4Camera.grasp_timelength_min",grasp_timelength_min);
    }
    ...
    public void setRecordUpTo(int recordUpTo) {
       ...
       // getPrefs().putInt("PawTrackerStereoBoard4Camera.recordUpTo",recordUpTo);
    }
...
//        
//        getPrefs().putBoolean("PawTrackerStereoBoard4Camera.throwAwayEvents",throwAwayEvents);
//    }
    ...
    public void setY_rotation_dist(float y_rotation_dist) {
       ...
       getPrefs().putFloat("PawTrackerStereoBoard4Camera.y_rotation_dist",y_rotation_dist);
    }
