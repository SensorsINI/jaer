...
public class RNNfilter extends EventFilter2D implements FrameAnnotater, PropertyChangeListener {
	...
	/**
	 * Chooses the time length for the bin, the current network is trained on 5ms data, hence the variable is
	...
	/**
	 * True if the filter intends to process RNN only when you click a button, if false it is a continuous RNN
	 * processing
	 */
	private boolean clickToProcess = getBoolean("clickToProcess", true);
	/**
	 * If needed to click to process RNN, choose if the RNN process happens as a batch at the end or in a continuous
	 * live setting
	 */
	...
	/**
	 * Number of channels (frequencies), when a user chooses a number other 64 an appropriately trained network has to
	 * be initialized
	 */
	...
	/**
	 * When not using continuous live recording, this array list holds the list of binned data at all previous times,
	 * which is then given to an RNN network
	 */
	...
	/**
	 * Choose which type of function you want the filter to perform, 0 stands for continuous recording, 1 stands for
	...
	/**
	 * Updates the bin data and if the timeStamp is past the bin time length, either the RNN network is processed or the
	 * bin is updated in the arraylist of bins
	 *
	 * @param timeStamp
	 *            - timestamp of the event
	 * @param channel
	 *            - which channel is the event from
	 * @param ear
	 *            - which ear is the event from
	 * @param neuron
	 *            - which neuron is the event from
	 * @param filterType
	 *            - which filter type is the event from
	 */
	...
	/**
	 * Updates the binned data list, given the latest time stamp it even adds the necessary zeros to the network, but
	 * does not reset the current bin data
	 *
	 * @param timeStamp
	 */
	...
	/**
	 * Removes the zero slices from the beginning and the ending and gives the resulting binned array list of arrays;
	 * currently not used
	 *
	 * @return
	 */
	 ...
	 *
	 * @param channel1
	 *            - frequency channel of the input event
	 * @param ear1
	 *            - the ear the input event is from
	 * @param neuron1
	 *            - the neuron the input event is from
	 * @param filterType1
	 *            - the filterType the input event is from
	 ...
	 *
	 * @param timeStamp
	 *            - the timestamp of the present event
	 */
	 ...
	 *
	 * @param floatMatrix
	 *            - 1 dimensional float matrix, there is no check make sure the input is indeed 1 dimensional
	...
	/**
	 * @param binTimeLength1
	 *            the binTimeLength to set
	 */
	...
	/**
	 * @param useAllNeurons1
	 *            the useAllNeurons to set
	 */
	...
	/**
	 * @param lastRNNXMLFile1
	 *            the lastRNNXMLFile to set
	 */
	...
	/**
	 * @param useBothFilterTypes1
	 *            the useBothFilterTypes to set
	 */
	...
	/**
	 * @param chooseFilterType1
	 *            the chooseFilterType to set
	 */
	...
	/**
	 * @param displayActivations
	 *            the displayActivations to set
	 */
	...
	/**
	 * @param displayAccuracy
	 *            the displayAccuracy to set
	 */
	...
	/**
	 * @param showPredictionOnlyIfGood
	 *            the showPredictionOnlyIfGood to set
	 */
	...
	/**
	 * @param batchRNNProcess
	 *            the batchRNNProcess to set
	 */
