...
public class DirectionSelectiveFlow extends AbstractMotionFlow {
    ...
    @Override synchronized public EventPacket filterPacket(EventPacket in) {
        ...
        for (Object ein : oriPacket) {
             ...
             * output an event at all, based on average delay. If an event does 
             * not pass tests for being a motion event, we use 'continue' to NOT 
             ...
             * hence where the number of found events is larger. If both directions 
             * produce equal number of events we assign the direction with slower 
             * speed as the motion direction. The very very rare case of equal 
             * number of events and equal speed is asigned to the 'positive' search
             * direction.
             */
            if (n1 == 0 && n2 == 0) v = 0;
    ...
    public int getMinDtThreshold() {return this.minDtThreshold;}
