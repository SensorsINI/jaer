...
package ch.unizh.ini.jaer.projects.opticalflowMDC2D.graphics;
 ...
 * @author  tobi
 */
public class MotionViewerMDC2D extends javax.swing.JFrame implements PropertyChangeListener, DropTargetListener {
    ...
    static Preferences prefs=Preferences.userNodeForPackage(MotionViewerMDC2D.class);
     ...
     *
     */
    public MotionViewerMDC2D(Chip2D chip){
        try {
...
//    }
    ...
    synchronized void makeCanvas(){
        ...
        JPanel cp=new OpticalFlowDisplayControlPanel((OptFlowDisplayMethod)chip.getCanvas().getDisplayMethod());
...
//            }
            ...
            if(sequenceDir.exists()){
                JOptionPane.showMessageDialog(MotionViewerMDC2D.this, sequenceName+" already exists");
                return;
            }
            boolean madeit=sequenceDir.mkdir();
            if(!madeit){
                JOptionPane.showMessageDialog(MotionViewerMDC2D.this, "couldn't create directory "+sequenceName);
                return;
            }
            frameNumber=0;
...
//            fileChooser.setFileFilter(datFileFilter);
            ...
            int retValue=fileChooser.showOpenDialog(MotionViewerMDC2D.this);
...
//                    }
        ...
        synchronized public void startPlayback(File file) throws FileNotFoundException {
            ...
            try{
                ...
                motionInputStream.getSupport().addPropertyChangeListener(MotionViewerMDC2D.this);
...
//            System.out.println(Thread.currentThread()+" MotionViewer.AEPlayer.rewind() called, rewinding "+motionInputStream);
        ...
        public void pause(){
            MotionViewerMDC2D.this.setPaused(true);
        }
        
        public void resume(){
            MotionViewerMDC2D.this.setPaused(false);
        }
        ...
        public void setPaused(boolean yes){
            MotionViewerMDC2D.this.setPaused(yes);
        }
        ...
        public boolean isPaused() {
            return MotionViewerMDC2D.this.isPaused();
        }
