 ...
 * @author tobi
 */
public class OptFlowDisplayMethod extends DisplayMethod {
    
//    HighpassFilter uxFilter, uyFilter, phFilter;
//    long startTime=System.currentTimeMillis();
//    final int TAU_MS=1000;
    Preferences prefs=Preferences.userNodeForPackage(OptFlowDisplayMethod.class);
     ...
     */
    public OptFlowDisplayMethod(ChipCanvas canvas) {
        super(canvas);
