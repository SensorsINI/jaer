...
/**
 * Class for providing editing abilities to the GUI. An instance of
 * ParameterContainer will self-inspect itself and discover Getter- and
 * Setter-Functions as well as functions starting with 'do'. These functions are
 * used by instances of {@link ParameterBrowserPanel} to provide basic editing
 * abilities to the object. In addition, Getter- and Setter-functions are used
 * to store parameters in the settings.
 *
 * @author Dennis Goehlsdorf, derived from Peter OConnor's Controllable, which
 * was derived from Tobi Delbruck's EventFilter
 */
/**
 * @author Dennis
 *
...
//		this.prefs = parentPrefs.node(nodeName);
    ...
    /**
     * Allows the definition of custom controls for child classes of
     * ParameterContainer. Overwrite this function to define additional control
     * elements for child classes!
     *
     * @return A newly created instance of JComponent containing custom
     * controls.
     */
...
//	}
    ...
    /**
     * Uses self-reflection to discover editable parameters. These parameters
     * will be monitored and changes will be saved in a Settings-file, which
     * allows automatic restoration of parameters.
     */
...
//  							getPrefs().putInt(propertyName, (Integer)newValue);
     ...
     *
     * @param propertyName The name of the property which should be excluded
     * from automatic GUI creation.
     */
    ...
    /**
     * Returns whether a certain property should be excluded from automatic GUI
     * creation.
     *
