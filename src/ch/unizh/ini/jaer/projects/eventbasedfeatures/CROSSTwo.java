 ...
 * @author Varad
 */
public class CROSSTwo extends DescriptorScheme{
    
    public CROSSTwo(AEChip chip, ConvolutionFeatureScheme featurescheme){
    ...
    public int[] getXArray(KeyPoint kp){
        int[] xarray = {kp.x, kp.x, kp.x+1, kp.x, kp.x-1, kp.x, kp.x+2, kp.x, kp.x-2};
        return xarray;
    }
    
    public int[] getYArray(KeyPoint kp){
        int[] yarray = {kp.y, kp.y+1, kp.y, kp.y-1, kp.y, kp.y+2, kp.y, kp.y-2, kp.y};
        return yarray;
    }
}
