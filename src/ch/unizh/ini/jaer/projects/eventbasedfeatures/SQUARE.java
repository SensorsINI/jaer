 ...
 * @author Varad
 */
public class SQUARE extends DescriptorScheme {
           
    public SQUARE(AEChip chip, ConvolutionFeatureScheme featurescheme){
    ...
    public int[] getXArray(KeyPoint kp){
        int[] xarray = {kp.x, kp.x, kp.x+1, kp.x+1, kp.x+1, kp.x, kp.x-1, kp.x-1, kp.x-1};
        return xarray;
    }
    
    public int[] getYArray(KeyPoint kp){
        int[] yarray = {kp.y, kp.y+1, kp.y+1, kp.y, kp.y-1, kp.y-1, kp.y-1, kp.y, kp.y+1};
        return yarray;
    }
}
