 ...
 * @author lou, tobi
 */
public class eDVS128_SerialPortHardwareInterface implements SerialInterface, HardwareInterface, AEMonitorInterface, BiasgenHardwareInterface, Observer {

    public static final int BAUD_RATE = 4000000;
    protected static Preferences prefs = Preferences.userNodeForPackage(eDVS128_SerialPortHardwareInterface.class);
    ...
    public eDVS128_SerialPortHardwareInterface(String deviceName) throws FileNotFoundException {
        try {
    ...
    public class AEReader extends Thread implements Runnable {
        ...
        eDVS128_SerialPortHardwareInterface monitor;

        public AEReader(eDVS128_SerialPortHardwareInterface monitor) {
...
//                    }
        ...
        synchronized public void resetTimestamps() {
            log.info(eDVS128_SerialPortHardwareInterface.this + ": wrapAdd=" + wrapAdd + ", zeroing it");
            wrapAdd = WRAP_START;
