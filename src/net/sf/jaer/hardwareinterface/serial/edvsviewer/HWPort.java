...
public abstract class HWPort {
	...
	protected byte[] inputBuffer = new byte[inputBufferSize];
        ...
        /** Identifies port for later opening it.
         * 
         */
	public class PortIdentifier {
		...
		String display;
                 ...
                 * 
                 * @param id - the ID of the port, typically e.g. "COM3" under Windows.
		...
		public String toString() {
			return(display);
                ...
                /** Returns identifier.
                 * 
                 * @return identifier, used to open.
                 */
		public Object getID() {
			return(id);
		}
	}
	abstract List<PortIdentifier> getPortIdentifierList();
        /** Contains attributes of the port, e.g. baud rate.
         * 
         */
	...
	abstract List<PortAttribute> getPortAttributeList();
	...
	abstract public int purgeInput();
