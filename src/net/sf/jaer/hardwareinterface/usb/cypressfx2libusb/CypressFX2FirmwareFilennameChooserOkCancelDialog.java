...
public class CypressFX2FirmwareFilennameChooserOkCancelDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        infoLabel.setText("<html>Choose the .bix firmware file you wish to download to this device.<p>These files are usually located in either the folder <em>../../devices/firmware/CypressFX2/</em> or the package <em>net.sf.jaer.hardwareinterface.usb</em> <p>The firmware file will be a .bix file.<html>");
