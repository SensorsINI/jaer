...
public class CypressFX2 implements AEMonitorInterface, ReaderBufferControl, USBInterface, HasUsbStatistics {
     ...
     * should already hold {@link #aePacketRawPool} (USB {@code translateEvents}).
     */
    ...
    /** DVS128 typed demux overrides to rewind {@code UsbPolarityBundleBuilder}. */
        ...
        public boolean stopThread() {
            ...
            if (!stopped) {
                ...
                if (!Thread.holdsLock(monitor)) {
                    ...
                    CypressFX2.log.warning("CypressFX2 AEReader join timed out during close; not starting USB-recover");
                }
                return false;
            }
            usbTransfer = null;
    ...
    void recoverFailedBufferReconfig(Exception cause) {
        ...
        if (Thread.holdsLock(this)) {
            CypressFX2.log.warning("CypressFX2 already in synchronized close(); skipping USB-recover");
            return;
        }
        new Thread(() -> {
            try {
