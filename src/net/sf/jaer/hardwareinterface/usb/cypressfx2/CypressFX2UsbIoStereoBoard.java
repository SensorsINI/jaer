...
/**
 * The USBIO hardware interface for the singleton Patrick Lichtsteiner StereoBoard pair of DVS128 chips.
 *
 * @author tobi/rapha
 */
public class CypressFX2UsbIoStereoBoard extends CypressFX2Biasgen {
    
    /** Creates a new instance of CypressFX2Biasgen */
    protected CypressFX2UsbIoStereoBoard(int devNumber) {
        super(devNumber);
    }
