 ...
 * displays another list given as a parameter
 * in the right panel,
 * and accepts a list of default class names.
 * The user can choose which classes and these
 * are returned by a call to getList.
