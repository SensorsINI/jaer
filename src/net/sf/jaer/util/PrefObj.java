...
/**
 * Stores objects and loads them from Java Preferences, even if they are larger
 * than what a Preferences value can hold individually.
 *
 * From https://www.ibm.com/developerworks/library/j-prefapi/index.html
 *
 */
public class PrefObj {
    ...
    /**
     * Stores object to preferences, even if it is too large for usual
     * Preferences String
     *
     * @param prefs the Preferences; obtain for example in an EventFilter with
     * getChip().getPrefs()
     * @param key your key
