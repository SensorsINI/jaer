...
/**
 * Plays sound samples which are specified by constructing the player and starting the thread.
 * 
...
public class PlayWavFile extends Thread {
    ...
    /** Sets up to play a wav file at normal center position. To actually play the file, start the thread.
     *
     * @param wavfile filename (including path if not in startup folder), or resource path.
     */
    ...
    /** Sets up to play a wav file at specified stereo position. To actually play the file, start the thread.
     *
     * @param wavfile filename (including path if not in startup folder), or resource path.
