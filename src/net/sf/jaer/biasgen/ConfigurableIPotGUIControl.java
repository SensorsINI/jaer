...
public class ConfigurableIPotGUIControl extends javax.swing.JPanel implements Observer, StateEditable {
    ...
    public ConfigurableIPotGUIControl(ConfigurableIPotRev0 pot) {
        ...
        bitViewEnabled = prefs.getBoolean("ConfigurableIPot.bitViewEnabled", false);
...
//        System.out.println(" storeState "+pot);
        hashtable.put(KEY_BITVALUE, pot.getBitValue());
        hashtable.put(KEY_BUFFERBITVALUE, pot.getBufferBitValue());
        ...
        public VisibleSetter(String myName) {
            ...
            addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    try {
                        setMethod.invoke(ConfigurableIPotGUIControl.class, isSelected());
