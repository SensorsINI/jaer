...
public class PotGUIControl extends javax.swing.JPanel implements Observer, StateEditable {
    ...
    public PotGUIControl(Pot pot) {
        ...
        sliderEnabled = prefs.getBoolean("PotGUIControl.sliderEnabled", true);
        valueEnabled = prefs.getBoolean("PotGUIControl.valueEnabled", true);
        bitValueEnabled = prefs.getBoolean("PotGUIControl.bitValueEnabled", false);
        bitViewEnabled = prefs.getBoolean("PotGUIControl.bitViewEnabled", false);
        sexEnabled = prefs.getBoolean("PotGUIControl.sexEnabled", true);
        typeEnabled = prefs.getBoolean("PotGUIControl.typeEnabled", true);
...
//        System.out.println(" storeState "+pot);
    ...
    public  void setSexEnabled(final boolean sexEnabled) {
        ...
        prefs.putBoolean("PotGUIControl.sliderEnabled", sexEnabled);
    }
