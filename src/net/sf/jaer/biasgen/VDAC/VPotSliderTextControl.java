...
public class VPotSliderTextControl extends JPanel implements Observer, StateEditable {
    ...
    boolean sliderEnabled = prefs.getBoolean("VPotGUIControl.sliderEnabled", true);
    boolean valueEnabled = prefs.getBoolean("VPotGUIControl.voltageEnabled", true);
...
//        System.out.println(" storeState "+pot);
    ...
    public void setVoltageEnabled(final boolean voltageEnabled) {
        this.valueEnabled = voltageEnabled;
