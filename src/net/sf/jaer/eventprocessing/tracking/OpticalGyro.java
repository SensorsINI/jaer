...
public class OpticalGyro extends RectangularClusterTracker implements FrameAnnotater {
	...
	public class SmallAngleTransformFinder {
		...
		public void update(int t) {
			...
			//                float a = -0.1f;
			////                for ( int i = 0 ; i < 30 ; i++ ){
			////                    clusters.append(new DebugCluster(random.nextInt(128),random.nextInt(128),tx,ty,a));
			////                }
			//                     clusters.append(new DebugCluster(64,74,tx,ty,a));
			//                     clusters.append(new DebugCluster(74,74,tx,ty,a));
			//                     clusters.append(new DebugCluster(74,64,tx,ty,a));
			//               n = clusters.size();
