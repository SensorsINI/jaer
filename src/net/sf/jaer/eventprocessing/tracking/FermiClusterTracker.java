...
public class FermiClusterTracker extends EventFilter2D implements FrameAnnotater, Observer /*, PreferenceChangeListener*/ {
	 ...
	 *
	 */
	public FermiClusterTracker(AEChip chip) {
		super(chip);
		this.chip = chip;
	...
	public class Cluster {
		...
		public Cluster() {
			...
			setAspectRatio(FermiClusterTracker.this.getAspectRatio());
	 ...
	 */
	public java.util.List<FermiClusterTracker.Cluster> getClusters() {
		return clusters;
	}

	private LinkedList<FermiClusterTracker.Cluster> getPruneList() {
		return pruneList;
	}
	...
	public synchronized void setLogDataEnabled(boolean logDataEnabled) {
		...
		if (!logDataEnabled) {
			...
			try {
				logStream = new PrintStream(new BufferedOutputStream(new FileOutputStream(new File("E:/FermiRecordings/FermiClusterTrackerLog.txt"))));
