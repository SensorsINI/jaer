...
public class FilterPanel extends javax.swing.JPanel implements PropertyChangeListener {
    ...
    private GroupPanel ungroupedControls = null;
...
//            }
    ...
    private void addIntrospectedControls() {
        ...
        ungroupedControls = new GroupPanel("(Ungrouped)");
...
//        add(Box.createHorizontalGlue());
        if (ungroupedControls.isPopulated()) {
            controlsPanel.add(Box.createVerticalStrut(0));
            controlsPanel.add(ungroupedControls);
        }
...
//                }
    ...
    /** Overridden to set enclosed filters visible or not depending on FilterFrame hideDisabled flag
     * 
     * @param visible 
     */
    @Override
