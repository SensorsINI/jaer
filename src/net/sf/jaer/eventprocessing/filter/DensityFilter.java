...
/**
 * An filter that filters slow background activity by only passing events that are supported by another event in the past {@link #setDt dt} in the immediate spatial neighborhood, defined by a subsampling bit shift.
 *
 * @author tobi
 */
...
public class DensityFilter extends AbstractNoiseFilter {
    ...
    /**
     * filters in to out. if filtering is enabled, the number of out may be less than the number putString in
     *
