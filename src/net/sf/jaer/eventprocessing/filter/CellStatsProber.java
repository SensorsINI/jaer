...
public class CellStatsProber extends EventFilter2D implements FrameAnnotater, MouseListener, MouseMotionListener, Observer,
	...
	/**
	 * @param isiHistEnabled
	 *            the isiHistEnabled to set
	 */
	...
	/**
	 * @param spikeSoundEnabled
	 *            the spikeSoundEnabled to set
	 */
	...
	public void setShowLatencyHistogramToExternalInputEvents(boolean showLatencyHistogramToSpecialEvents) {
		stats.setShowLatencyHistogramToExternalInputEvents(showLatencyHistogramToSpecialEvents);
	}
	...
	/**
	 * @param scaleHistogramsIncludingOverflow
	 *            the
	...
	private class Stats {
		...
		/**
		 * @param showAverageISIHistogram
		 *            the showAverageISIHistogram to set
		 */
		public void setShowAverageISIHistogram(boolean showAverageISIHistogram) {
		...
		/**
		 * @param showIndividualISIHistograms
		 *            the showIndividualISIHistograms to
		 *            set
		 */
		public void setShowIndividualISIHistograms(boolean showIndividualISIHistograms) {
		...
		/**
		 * @param showLatencyHistogramToSpecialEvents
		 *            the
		 *            showLatencyHistogramToExternalInputEvents to set
		 */
		public void setShowLatencyHistogramToExternalInputEvents(boolean showLatencyHistogramToSpecialEvents) {
			this.showLatencyHistogramToExternalInputEvents = showLatencyHistogramToSpecialEvents;
			putBoolean("showLatencyHistogramToExternalInputEvents", showLatencyHistogramToSpecialEvents);
		}
		...
		/**
		 * @param externalInputEventAddress
		 *            the externalInputEventAddress to set
		 */
		public void setExternalInputEventAddress(int externalInputEventAddress) {
		...
		/**
		 * @param individualISIsEnabled
		 *            the individualISIsEnabled to set
		 */
		public void setIndividualISIsEnabled(boolean individualISIsEnabled) {
		...
		/**
		 * @param isiAutoScalingEnabled
		 *            the isiAutoScalingEnabled to set
		 */
