...
public class CellStatsProber extends EventFilter2D implements FrameAnnotater, MouseListener, MouseMotionListener, Observer, PropertyChangeListener {
    ...
    public CellStatsProber(AEChip chip) {
        ...
        setPropertyTooltip(l, "showLatencyHistogramToExternalInputEvents", "(not yet implemented) Shows a histogram of latencies of each pixel in selected region relative to external input event address generated by input to external input pin"); // TODO not yet implemented
    ...
    private class Stats {
        ...
        /**
         * @param showLatencyHistogramToSpecialEvents the
