...
public class CellStatsProber extends EventFilter2D implements FrameAnnotater, MouseListener, MouseMotionListener, Observer,PropertyChangeListener {
    ...
    public CellStatsProber(AEChip chip) {
        ...
        setPropertyTooltip(h, "showLatencyHistogramToExternalInputEvents","(not yet implemented) Shows a histogram of latencies of each pixel in selected region relative to external input event address generated by input to external input pin"); // TODO not yet implemented
    ...
    public boolean isShowLatencyHistogramToSpecialEvents() {
        return stats.isShowLatencyHistogramToExternalInputEvents();
    }

    public void setShowLatencyHistogramToSpecialEvents(boolean showLatencyHistogramToSpecialEvents) {
    ...
    private class Stats {
        ...
        /**
         * @param showLatencyHistogramToSpecialEvents the showLatencyHistogramToExternalInputEvents to set
         */
