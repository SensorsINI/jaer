...
//        gl.glTranslatef(-.5f, -.5f, 0);
    ...
    /**
     * Fills timestampImage with waiting times drawn from Poisson process with rate noiseRateHz
     *
     * @param noiseRateHz rate in Hz
     * @param lastTimestampUs the last timestamp; waiting times are created before this time
     */
    @Override
    ...
    /**
     * Loads a convolutional neural network (CNN) trained using DeapLearnToolbox for Matlab (https://github.com/rasmusbergpalm/DeepLearnToolbox) that was exported using Danny Neil's XML Matlab script cnntoxml.m.
     *
     */
...
//    }
    ...
    /**
     * build correction table to improve result in region of interest. If region of interest is large enough then improves result everywhere
     */
    ...
    /**
     * When this is selected in the FilterPanel GUI, the mouse listeners will be added. When this is unselected, the listeners will be removed.
     *
     */
    @Override
    ...
    /**
     * Returns the chip pixel position from the MouseEvent. Note that any calls that modify the GL model matrix (or viewport, etc) will make the location meaningless. Make sure that your graphics rendering code wraps transforms inside pushMatrix and popMatrix calls.
     *
