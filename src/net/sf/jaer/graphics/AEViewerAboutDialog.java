    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(layout.createSequentialGroup()
                        .add(versionLabel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 514, Short.MAX_VALUE)
                        .addContainerGap())
                    .add(layout.createSequentialGroup()
                        .add(aboutLabel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 357, Short.MAX_VALUE)
                        .add(167, 167, 167))))
        );
        layout.setVerticalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(versionLabel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 277, Short.MAX_VALUE)
                .add(18, 18, 18)
