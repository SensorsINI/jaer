 ...
 * @author  tobi
 */
public class GimbalGUI extends javax.swing.JFrame implements ExceptionListener {
     ...
     */
    public GimbalGUI(GimbalBase pt, GimbalCalibrator calibrator) {
    ...
    private void calibrationPanelKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_calibrationPanelKeyPressed
        switch (evt.getKeyCode()) {
            case KeyEvent.VK_SPACE:
                ...
                support.firePropertyChange(Message.AddSample.name(), null, new GimbalCalibrationPoint(new Point2D.Float(), (Point2D.Float)lastPanTilt.clone(), (Point)lastMousePressLocation.clone()));
                repaint();
                return;
