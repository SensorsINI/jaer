 ...
 * @author andstein
 */
public class GimbalParserPanel extends javax.swing.JPanel 
{
    
    static Logger log = Logger.getLogger(GimbalParserPanel.class.getName());
    ...
    private void initComponents() {
        ...
        msText.setFont(new java.awt.Font("Courier New", 0, 11)); // NOI18N
        msText.setText("1.0");
