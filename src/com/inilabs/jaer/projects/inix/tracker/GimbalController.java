...
import com.inilabs.jaer.projects.inix.gimbal.*;
...
//		}
              ...
              cGLUT.glutBitmapString(font, String.format("TARGET(width, mixingF)=%.1f, %.3f", tracker.getTargetWidth(), tracker.getMixingFactor()));
  //              cGLUT.glutBitmapString(font, String.format("GIMBAL***(pan,tilt,roll)=%.1f, %.1f, %.1f deg ", 220.0, 6.0, 0.0));
