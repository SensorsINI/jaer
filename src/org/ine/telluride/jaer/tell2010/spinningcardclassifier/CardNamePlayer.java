package org.ine.telluride.jaer.tell2010.spinningcardclassifier;
import ch.unizh.ini.jaer.projects.gesture.virtualdrummer.*;
import java.io.*;
 ...
 * Use it by constructing a new {@link CardNamePlayer}, then calling the {@link #play} method.
 ...
 */
public class CardNamePlayer implements SoundPlayerInterface{
...
//    private AudioInputStream spikeStream, spikeStreamLeft, spikeStreamRight;
    ...
    static final Logger log = Logger.getLogger("CardNamePlayer");
    private CardNamePlayerThread T ;
...
//        System.out.println("notifying player thread");
    ...
    public static ArrayList<String> getSoundFilePaths (){
        ...
        try{
            ...
            inputStream = CardNamePlayer.class.getResourceAsStream(pathHeader+filename);
            if ( inputStream == null ){
   ...
   public final synchronized boolean setFile (int soundNumber) throws UnsupportedAudioFileException,FileNotFoundException,IOException{
    ...
    private class CardNamePlayerThread extends Thread{
        public CardNamePlayerThread (){
            super("CardNamePlayerThread");
        }
...
//                    System.out.println("filling line");
    ...
    static class SSTest extends JFrame{
        ...
        public SSTest () throws HeadlessException{
            ...
            try{
                Random r=new Random();
                ss = new CardNamePlayer(r.nextInt(CardNamePlayer.getSoundFilePaths().size()));
            } catch ( Exception e ){
                e.printStackTrace();
                System.exit(1);
            }
