...
/**
 * 
 * This is a version before the modification to adapt to caffe, only works with DeepLearnToolbox 
 * Hopefully will be removed after debugging the main version to  work with patch processing for HeatMapCNN
 ...
 * @author tobi
 */
public class DeepLearnCnnNetwork_HJ {
     ...
     * @see #getActivations
     */
    public float[] processDownsampledFrame(DavisRenderer frame) {
        if (inputLayer == null) {
            return null;
        }
...
//                break; // DEBUG only first layer
    ...
    public class InputLayer extends Layer {
         ...
         */
        public float[] processDownsampledFrame(DavisRenderer renderer) {
