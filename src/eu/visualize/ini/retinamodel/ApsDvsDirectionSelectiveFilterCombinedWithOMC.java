...
public class ApsDvsDirectionSelectiveFilterCombinedWithOMC extends AbstractDirectionSelectiveFilter {

    public ApsDvsDirectionSelectiveFilterCombinedWithOMC(AEChip chip) {
        super(chip);
