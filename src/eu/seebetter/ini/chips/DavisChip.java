...
abstract public class DavisChip extends AETemporalConstastRetina {
    ...
    public static final String 
            PROPERTY_AUTO_EXPOSURE_ENABLED = "PROPERTY_AUTO_EXPOSURE_ENABLED", 
            PROPERTY_AUTO_EXP_DELTA = "PROPERTY_AUTO_EXP_DELTA";
    public static String PROPERTY_UNDER_OVER_DELTA="PROPERTY_UNDER_OVER_DELTA";
    public static String PROPERTY_LOW_BOUNDARY="PROPERTY_LOW_BOUNDARY";
    public static String PROPERTY_HIGH_BOUNDARY="PROPERTY_HIGH_BOUNDARY";
    public static String PROPERTY_PID_CONTROLLER_ENABLED="PROPERTY_PID_CONTROLLER_ENABLED";
