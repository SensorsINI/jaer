...
/**
 * Production iniVation DAVIS346 color (RGBG CFA) in the red case, USB 3.0 FX3.
 * Same APS readout and user-friendly hardware panel as {@link Davis346red}.
 * Color frames use {@link DavisColorRenderer} / {@link DavisBaseCamera.DavisColorEventExtractor}.
 */
@Description("DAVIS346 346x260 pixel APS-DVS DAVIS USB 3.0 color sensor (red case)")
@DevelopmentStatus(DevelopmentStatus.Status.Stable)
public class Davis346redColor extends Davis346red {
