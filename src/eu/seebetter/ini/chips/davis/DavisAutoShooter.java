...
public class DavisAutoShooter extends EventFilter2D implements FrameAnnotater {
	...
	/**
	 * @param eventCountThresholdKEvents
	 *            the eventCountThresholdKEvents to set
	 */
	...
	/**
	 * @param trackerMovementPixelsForNewFrame
	 *            the trackerMovementPixelsForNewFrame to set
	 */
	...
	/**
	 * @param useEventRateThreshold
	 *            the useEventRateThreshold to set
	 */
