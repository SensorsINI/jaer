...
public class DavisConfig extends LatticeLogicConfig implements DavisDisplayConfigInterface, DavisTweaks, HasPreference {
   ...
   protected JPanel configPanel;
    ...
    public JPanel buildControlPanel() {
        ...
        getVideoControl().addObserver(videoParameterControlPanel); // TODO this is trick to get the ParameterControlPanel to listen to Observerable changes in videoControl
...
//            getSupport().firePropertyChange(PROPERTY_EXPOSURE_DELAY_US, old, getExposureDelayUS());
        ...
        public void update(Observable o, Object arg) {
            // these updates are generated by the ParameterControlPanel when properties are changed; here we fire the PropertyChangeEvents to update listeners on this configuration class
            if (o == runAdc) {
                getSupport().firePropertyChange(DavisDisplayConfigInterface.PROPERTY_CAPTURE_FRAMES_ENABLED, null, runAdc.isSet());
