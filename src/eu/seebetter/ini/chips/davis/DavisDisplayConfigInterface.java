...
public interface DavisDisplayConfigInterface extends DvsDisplayConfigInterface {
	...
	public static final String PROPERTY_CAPTURE_EVENTS_ENABLED = "PROPERTY_CAPTURE_EVENTS_ENABLED",
        ...
        /** Color property change event keys */
        public static final String PROPERTY_MONOCHROME="PROPERTY_MONOCHROME", 
                PROPERTY_SEPARATE_COLORS="PROPERTY_SEPARATE_COLORS", 
                PROPERTY_COLOR_CORRECTION="PROPERTY_COLOR_CORRECTION", 
                PROPERTY_AUTO_WHITE_BALANCE="PROPERTY_AUTO_WHITE_BALANCE";
