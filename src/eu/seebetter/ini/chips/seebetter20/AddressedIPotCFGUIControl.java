 ...
 */
import eu.seebetter.ini.chips.seebetter20.AddressedIPotCF.*;
import eu.seebetter.ini.chips.seebetter20.AddressedIPotCF.CurrentLevel;
...
//        System.out.println(pot+" set combobox selected="+biasEnabledComboBox.getSelectedItem());
    ...
    private int coarseSliderValueFromBitValue() {
        int s = bitVal2SliderVal(pot.getCoarseBitValue(), pot.getMaxCoarseBitValue(), coarseBiasSlider);
        return s;
    }
