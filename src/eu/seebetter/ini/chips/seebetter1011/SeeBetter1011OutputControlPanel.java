...
public class SeeBetter1011OutputControlPanel extends javax.swing.JPanel {
    ...
    class OutputSelectionAction extends AbstractAction implements Observer {
        ...
        SeeBetter1011.cDVSTestBiasgen.OutputMux mux;
        int channel;
        JRadioButton button;

        OutputSelectionAction(SeeBetter1011.cDVSTestBiasgen.OutputMux m, int i) {
    ...
    void buildPanel() {
        ...
        panelBuilt = true;
        SeeBetter1011.cDVSTestBiasgen biasgen = (SeeBetter1011.cDVSTestBiasgen) chip.getBiasgen();
        SeeBetter1011.cDVSTestBiasgen.AllMuxes muxes = biasgen.allMuxes;
        for (SeeBetter1011.cDVSTestBiasgen.OutputMux m : muxes) {
            JPanel p = new JPanel();
            p.setAlignmentY(0);
