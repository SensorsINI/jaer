...
//                            System.out.println("");
    ...
    public class LogIntensityFrameData implements HasPreference {
        ...
        public void put(int val) {
            if (writeCounter >= currentWritingBuffer.length) {
...
//            System.out.println("on swapBuffers count="+writeCounter);
        ...
        @Override
        public String toString() {
            return "LogIntensityFrameData{" + "WIDTH=" + WIDTH + ", HEIGHT=" + HEIGHT + ", NUMSAMPLES=" + NUMSAMPLES + ", timestamp=" + timestamp + ", writeCounter=" + writeCounter + ", dataWrittenSinceLastSwap=" + dataWrittenSinceLastSwap + '}';
        }
