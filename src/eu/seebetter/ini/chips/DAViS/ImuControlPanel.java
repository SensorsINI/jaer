...
public class ImuControlPanel extends javax.swing.JPanel implements PropertyChangeListener {
	...
	private void initComponents() {
		...
		gyroFullScaleComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2",
			"Item 3", "Item 4" }));
		...
		jLabel3
			.setToolTipText("The basic sample rate when DLPF is disabled (DLPF=0) is 8kHz (1kHz when DLPF>0) for gyro and 1kHz for accelerometer. This divider reduces the sample rate by the selected factor.");

		accelFullScaleComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2",
			"Item 3", "Item 4" }));
		...
		sampleRateDividerTF.setHorizontalAlignment(SwingConstants.TRAILING);
		...
		jLabel4
			.setToolTipText("The DLPF is integrated to the IMU.  See Sec. 4.3 Configruation CONFIG. With DLPF=0, Accel BW=260Hz with delay=0 and Gyro BW=256Hz with 0.96ms delay, if Fs=8kHz.");

		dlpfTF.setHorizontalAlignment(SwingConstants.TRAILING);
					...
					layout
									...
									layout
										...
										.addGroup(
											layout
												.createSequentialGroup()
												.addGap(24, 24, 24)
												.addComponent(sampleRateDividerTF,
										...
										.addGroup(
											...
											layout
												...
												.addComponent(accelFullScaleComboBox, 0,
										...
										.addGroup(
											...
											layout
												.createSequentialGroup()
												.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
												.addComponent(gyroFullScaleComboBox, 0,
													javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
						.addGroup(
							layout.createSequentialGroup().addComponent(imuEnabledCB)
						...
						.addGroup(
							layout.createSequentialGroup().addComponent(jLabel4).addGap(18, 18, 18)
								.addComponent(dlpfTF))).addContainerGap()));
			...
			layout
				...
				.addGroup(
					layout
						...
						.addComponent(gyroFullScaleComboBox, javax.swing.GroupLayout.PREFERRED_SIZE,
				...
				.addGroup(
					layout
						...
						.addComponent(accelFullScaleComboBox, javax.swing.GroupLayout.PREFERRED_SIZE,
							javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
				.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
				.addGroup(
					layout
						...
						.addComponent(sampleRateDividerTF, javax.swing.GroupLayout.PREFERRED_SIZE,
							javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
				.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
				.addGroup(
					layout
						...
						.addComponent(dlpfTF, javax.swing.GroupLayout.PREFERRED_SIZE,
							javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
