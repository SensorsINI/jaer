...
| `Davis240C DVSFLOW16 Rotating Fan.aedat4`                                       | DAVIS240C                     | Optical-flow test: rotating fan (DVSFLOW16). Events, APS frames, IMU. |
| `Davis240C DVSFLOW16 Translating Boxes.aedat4`                                  | DAVIS240C                     | Optical-flow test: translating boxes (DVSFLOW16). Events, APS frames, IMU. |
...
| `DVS128 2007 robo goalie.aedat4`                                                | DVS128                        | Shorter RoboGoalie clip (same setup as the balls-and-arm file). |
...
| `DVS640 EssacSim Warehouse Quad walk env0_ep0.aedat4`                           | DVS640                        | [EssacSim](https://github.com/spikelab-jhu/isaac-sim-event-camera-plugin) (somewhat optimistic) simulated events from a quadruped walking through a warehouse. See [paper](https://arxiv.org/abs/2608.08522). |
...
| `DVS128 2007 robo goalie.aedat4` | 9.9 MB |
