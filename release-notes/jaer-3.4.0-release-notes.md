...
**If you later want to download Sample Data, choose a user folder, not the default location Program Files.** Fixed in **[3.5.0](https://github.com/SensorsINI/jaer/releases/tag/3.5.0)** (writable-folder chooser).
